    ...
    <div class="page-content container-fluid">
                        ...
                        @elseif($setting->type == "image" || $setting->type == "file")
                            @if(isset( $setting->value ) && !empty( $setting->value ) && !empty(Storage::url($setting->value)))
                                <div class="img_settings_container">
                                    <a href="/{{Settings::get('backend_uri')}}/settings/delete_value/{{ $setting->id }}"
                                       class="icon-x"></a>
        ...
        <div class="panel" id="import-site-data">
            ...
            <div class="panel-body">
                ...
                <button type="submit" class="btn btn-primary pull-right" onclick="this.form.submit();this.disabled=true">Import Data</button>

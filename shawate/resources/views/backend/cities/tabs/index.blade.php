                                        ...
                                        <div class="form-group {{!$errors->has("description.$localeCode")?:"has-error"}} ">
                                            ...
                                            <div class="col-sm-8">
                                                <textarea name="description[{{$localeCode}}]"
                                                          class="form-control ckeditor" id="description"
                                ...
                                @if($city->tabs()->count())
                                    @foreach($city->tabs as $row)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                @can('edit cities')
                                                    <a href="{{url("$locale/$backend_uri/countries/$country->id/cities/$city->id/tabs/{$row->id}/edit")}}"
                                                       class="btn btn-default btn-xs" data-toggle="tooltip"
                                                       data-placement="top" title="{{trans("main.tooltip_edit")}}"><i
                                                                class="fa fa-pencil"></i></a>
                                                @endcan
                                                @can('delete cities')
                                                    <a href="{{url("$locale/$backend_uri/countries/$country->id/cities/$city->id/tabs/{$row->id}/delete")}}"

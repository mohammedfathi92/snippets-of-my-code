...
@section('page_header')
    ...
    <div class="panel pale-default">
        <div class="panel-body"><span
                ...
                : <code>{!! Html::link("packages/{$data->id}/".str_slug($data->{"name:en"}),"/packages/{$data->id}/".str_slug($data->{"name:en"})) !!}</code></span>
        </div>
    </div>
@stop
@section("content")
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="tab-general">
                            ...
                            <div class="form-group {{$errors->has("people_count")?"has-error":''}}">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" name="people_count" min="1" value="{{old("people_count",$data->people_count)}}"
                                           class="form-control">
                        ...
                        <div role="tabpanel" class="tab-pane" id="tab-details">
                            ...
                            <div data-ng-controller="packageHotelsCtrl"
                                 data-ng-init="init('{{$data->country_id}}',{{$data->rooms->toJson()}})">

                                <div class="clearfix"></div>

                                {{--Hotels--}}
                                <h3 data-toggle="collapse" data-target="#citiesHotels" aria-expanded="false"
                                    aria-controls="citiesHotels">{{trans('packages.title_package_hotels')}} <span data-ng-show="hotelsLoading" class="btn-group-addon"><i
                            ...
                            <div data-ng-controller="packageTransportsCtrl"
                                ...
                                <h3 data-toggle="collapse" data-target="#packageTransports" aria-expanded="false"
                                    aria-controls="packageTransports">{{trans('packages.title_package_transports')}} <span data-ng-show="transportsLoading" class="btn-group-addon"><i
                                                class="fa fa-spinner fa-pulse fa-fw"></i></span></h3>
                                {{--Transports--}}
                            ...
                            <div data-ng-controller="packageFlightsCtrl" data-ng-init="init({{$data->flights}})">
                                <h3 data-toggle="collapse" data-target="#packageFlights" aria-expanded="false"
                                    aria-controls="packageFlights">{{trans('packages.title_package_flights')}} <span data-ng-show="flightsLoading" class="btn-group-addon"><i
                                                class="fa fa-spinner fa-pulse fa-fw"></i></span></h3>
                                {{--Transports--}}

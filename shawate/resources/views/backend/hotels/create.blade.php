...
@section('page_header')
    <h1 class="page-title">
        <i class="fa fa-h-square"></i> {{trans("hotels.backend_page_create_header")}} </h1>
@stop
@section("content")
                            ...
                            <div role="tabpanel" class="tab-pane {{$loop->index==0?"active":""}}"
                                ...
                                <div class="form-group {{!$errors->has("notes.$localeCode")?:"has-error"}}">
                                    <label for="meta_keywords"
                                           class="col-sm-3 control-label">{{trans("hotels.label_notes")}}
                                    </label>
                                    <div class="col-sm-9">
                        ...
                        <div class="form-group {{$errors->has("address")?"has-error":''}}">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="address" data-ng-model="address" class="form-control"
                                       value="{{old("address")}}" data-ng-init="address='{{old('address')}}'">
                    ...
                    <div class="form-group {{$errors->has("stars")?"has-error":''}}">
                        ...
                        <div class="col-sm-3">
                            <select name="stars" id="stars" class="form-control select2">
                                <option value="1" {{!old("stars")==1?:"selected"}}>{{trans_choice("hotels.hotel_stars_option",1)}}</option>
                                <option value="2" {{!old("stars")==2?:"selected"}}>{{trans_choice("hotels.hotel_stars_option",2)}}</option>
                                <option value="3" {{!old("stars")==3?:"selected"}}>{{trans_choice("hotels.hotel_stars_option",3)}}</option>
                                <option value="4" {{!old("stars")==4?:"selected"}}>{{trans_choice("hotels.hotel_stars_option",4)}}</option>
                                <option value="5" {{!old("stars")==5?:"selected"}}>{{trans_choice("hotels.hotel_stars_option",5)}}</option>
                                <option value="6" {{!old("stars")==6?:"selected"}}>{{trans_choice("hotels.hotel_stars_option",6)}}</option>
                                <option value="7" {{!old("stars")==7?:"selected"}}>{{trans_choice("hotels.hotel_stars_option",7)}}</option>
                            </select>
                            @if ($errors->has('stars'))
                                <span class="help-block">
                    ...
                    <div class="form-group {{$errors->has("in_country")?"has-error":''}}">
                        ...
                        <div class="col-md-9">
                            <input type="checkbox" name="in_country" id="in_country" class="toggle-checkbox"
                                   placeholder=""
                                   value="1" {{old("in_country")?"checked":""}}>
                        </div>
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    ...
                    <select name="services[]" multiple id="services" class="select2 form-control">
                        @foreach(\App\HotelService::all() as $service)
                            <option value="{{$service->id}}" {{!old("services.$loop->index")?:"selected" }}>{{$service->name}}</option>
                        @endforeach
                    </select>

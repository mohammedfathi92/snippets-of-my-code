                                ...
                                @if($hotel->tabs()->count())
                                    @foreach($hotel->tabs as $row)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                @can('edit hotels')
                                                    <a href="{{url("$locale/$backend_uri/hotels/$hotel->id/tabs/{$row->id}/edit")}}"
                                                       class="btn btn-default btn-xs" data-toggle="tooltip"
                                                       data-placement="top" title="{{trans("main.tooltip_edit")}}"><i
                                                                class="fa fa-pencil"></i></a>
                                                @endcan
                                                @can('delete hotels')
                                                    <a href="{{url("$locale/$backend_uri/hotels/$hotel->id/tabs/{$row->id}/delete")}}"

                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <select name="package_type" class="form-control " id="package_type"
                                    data-ng-model="package_type"
                                    data-ng-init="package_type='{{old("package_type",$data->package_type_id)}}'"
                                    data-ng-disabled="!country||!package_types.length">
                                <option value=""></option>
                                <option data-ng-repeat="item in package_types" value="<%item.id%>"><%item.name%>
                                </option>

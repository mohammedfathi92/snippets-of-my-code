        ...
        <div class="panel panel-default">
            ...
            @if(($data->booking_type=="hotel" ||$data->booking_type=="room")&&$data->hotel_id)
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <b><a href="{{url("hotels/{$data->hotel_id}/".str_slug($data->hotel->name))}}">{{$data->hotel->name}}</a></b>
                    </div>
                </div>
            @endif
            ...
            @if(($data->booking_type=="room")&&$data->room_id && $data->room)
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <b><a href="{{url("hotels/{$data->hotel_id}/".str_slug($data->hotel->name))}}">{{$data->room->name}}</a></b>
                    </div>
                </div>
            @endif
            @if($data->booking_type=="free" ||$data->package_type_id)
                <div class="form-group">
                    <label for="" class="control-label col-md-3">{{trans("bookings.label_package_type")}}</label>
                    <div class="col-md-5">
                        <b>{{$data->package_type_id?$data->package_type->name:"--"}}</b>
                    </div>
                </div>
            @endif
            @if(($data->booking_type=="package")&&$data->package_id)
                <div class="form-group">
                    ...
                    <div class="col-md-5">
                        <b><a href="{{url("packages/{$data->package_id}/".str_slug($data->package->name))}}">{{$data->package->name}}</a></b>
                    </div>
                </div>
            @endif

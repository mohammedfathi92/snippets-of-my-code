...
@section('page_header')
    <h1 class="page-title">
        <i class="fa fa-question-circle-o"></i> {{trans("faqQuestions.backend_page_update_header")}} </h1>
@stop
@section("content")
                            ...
                            <div role="tabpanel" class="tab-pane {{$loop->index==0?"active":""}}"
                                ...
                                <div class="form-group {{!$errors->has("question.$localeCode")?:"has-error"}} ">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="question[{{$localeCode}}]" class="form-control"
                                               id="question"
                                               placeholder="" value="{{old("question.$localeCode",$data->{"question:$localeCode"})}}">
                                ...
                                <div class="form-group {{!$errors->has("answer.$localeCode")?:"has-error"}}">
                                    ...
                                    <div class="col-sm-9">
                                            ...
                                            >{{old("answer.$localeCode",$data->{"answer:$localeCode"})}}</textarea>

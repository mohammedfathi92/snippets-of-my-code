                                ...
                                @if($country->tabs()->count())
                                    @foreach($country->tabs as $row)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                @can('edit countries')
                                                    <a href="{{url("$locale/$backend_uri/countries/$country->id/tabs/{$row->id}/edit")}}"
                                                       class="btn btn-default btn-xs" data-toggle="tooltip"
                                                       data-placement="top" title="{{trans("main.tooltip_edit")}}"><i
                                                                class="fa fa-pencil"></i></a>
                                                @endcan
                                                @can('delete countries')
                                                    <a href="{{url("$locale/$backend_uri/countries/$country->id/tabs/{$row->id}/delete")}}"

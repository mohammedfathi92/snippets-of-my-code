                    ...
                    <div class="form-group {{$errors->has("target")?"has-error":''}}">
                        ...
                        <div class="col-md-9">
                            <select name="target" id="target" class="form-control select2">
                                <option value="_self" {{ !old('target',$data->target)=="_self"?:"selected" }}>{{trans("menu_items.target_option._self")}}</option>
                                <option value="_blank" {{ !old('target',$data->target)=="_blank"?:"selected" }}>{{trans("menu_items.target_option._blank")}}</option>
                                <option value="_parent" {{ !old('target',$data->target)=="_parent"?:"selected" }}>{{trans("menu_items.target_option._parent")}}</option>
                                <option value="_top" {{ !old('target',$data->target)=="_top"?:"selected" }}>{{trans("menu_items.target_option._top")}}</option>
                    ...
                    <div class="form-group {{$errors->has("parent")?"has-error":''}}">
                        ...
                        <div class="col-md-9">
                            ...
                            <select name="parent" id="parent" class="form-control select2">
                                ...
                                @foreach($menu->items($data->id)->get() as $item)

                                    <option value="{{$item->id}}" {{!(old('parent',$data->parent_id)==$item->id)?:"selected" }}>{{$item->title}}</option>
                                @endforeach
                            </select>

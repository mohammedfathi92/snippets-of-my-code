...
@section('page_header')
    <h1 class="page-title">
        <i class="fa fa-h-square"></i> {{trans("testimonials.backend_page_create_header")}} </h1>
@stop
@section("content")
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                                ...
                                <div class="form-group {{!$errors->has("visitor_name.$localeCode")?:"has-error"}} ">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="visitor_name[{{$localeCode}}]" class="form-control"
                                               id="name"
                                               placeholder="" value="{{old("visitor_name.$localeCode")}}">
                                        @if ($errors->has("name.$localeCode"))
                                            <span class="help-block">
                                ...
                                <div class="form-group {{!$errors->has("nationality.$localeCode")?:"has-error"}} ">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="nationality[{{$localeCode}}]" class="form-control"
                                               id="name"
                                               placeholder="" value="{{old("nationality.$localeCode")}}">
                                        @if ($errors->has("name.$localeCode"))
                                            <span class="help-block">
                    ...
                    <div class="form-group {{$errors->has("type")?"has-error":''}}">
                        ...
                        <div class="col-sm-9">
                            <select name="type" id="type" class=" form-control select2" data-ng-model="type"
                                    data-ng-init="type='{{old("type","text")}}'">
                    ...
                    <div class="form-group {{$errors->has("trip_type")?"has-error":''}}">
                        ...
                        <div class="col-sm-9">
                            <select name="trip_type" id="trip_type" class=" form-control select2"
                                ...
                                <option value="1" {{old("trip_type")==1?"selected":""}}>{{trans_choice("testimonials.trip_type_options",1)}}</option>
                                <option value="2" {{old("trip_type")==2?"selected":""}}>{{trans_choice("testimonials.trip_type_options",2)}}</option>
                                <option value="3" {{old("trip_type")==3?"selected":""}}>{{trans_choice("testimonials.trip_type_options",3)}}</option>
                                <option value="4" {{old("trip_type")==4?"selected":""}}>{{trans_choice("testimonials.trip_type_options",4)}}</option>
                                <option value="5" {{old("trip_type")==5?"selected":""}}>{{trans_choice("testimonials.trip_type_options",5)}}</option>
                            </select>

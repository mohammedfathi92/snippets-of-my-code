    ...
    <div class="page-title-container">
        <div class="container">
            ...
            <ul class="breadcrumbs pull-right">
                ...
                <li><a href="{{url("/country/$country->id/".str_slug($country->{"name:en"}))}}">{{$country->name}}</a>
                </li>
                ...
                <div class="travelo-box filters-container faq-topics">
                    ...
                    <ul class="triangle filters-option">
                        @foreach($countries->get() as $country)
                            <li>
                                <a href="{{url("country/{$country->id}/".str_slug($country->{"name:en"})."/packages")}}">{{trans("packages.link_country_packages",['country'=>$country->name])}}</a>
                            </li>
                        @endforeach
                    </ul>

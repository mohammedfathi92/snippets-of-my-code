        ...
        <div class="col-sms-6 col-sm-8 col-md-9">
            <div class="booking-section travelo-box">
                ...
                <div class="person-information">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 col-md-5 {{$errors->has("institute_id")?"has-error":''}}">
                            <label for="country">{{trans("bookings.label_institute")}}</label>
                            @if($institute)
                                <div class="col-md-2">
                                    <a href="{{url("/institutes/$institute->id/".str_slug($institute->name))}}"
                                       target="_blank">
                                        <img src="{{url("files/{$institute->photo}?size=50,50")}}" alt="{{$institute->name}}">
                                        <input type="hidden" name="institute_id" value="{{$institute->id}}">
                                    </a>
                                </div>
                                <div class="col-md-9">
                                    <a href="{{url("/institutes/$institute->id/".str_slug($institute->name))}}"
                                       target="_blank">{{$institute->name}}</a>
                                </div>
                            @endif
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 col-md-5 {{$errors->has("course_id")?"has-error":''}}">
                            <label for="country">{{trans("bookings.label_course")}}</label>
                            @if($course)
                                <div class="col-md-2">
                                    <a href="{{url("/institutes/$institute->id/".str_slug($institute->name))}}"
                                       target="_blank">
                                        <img src="{{url("files/{$course->photo}?size=50,50")}}" alt="{{$course->name}}">
                                        <input type="hidden" name="course_id" value="{{$course->id}}">
                                    </a>
                                </div>
                                <div class="col-md-9">
                                    <a href="{{url("/institutes/$institute->id/".str_slug($course->name))}}"
                        ...
                        <div class="col-sm-6 col-md-5">
                            <label>{{trans("bookings.label_num_courses")}}</label>
                            <div class="">
                ...
                <hr/>
                <input type="hidden" name="booking_type" value="course">

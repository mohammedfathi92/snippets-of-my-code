  ...
  <div class="container">
    <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-xs-6 text-right">
               @if($booking->course->institute->bank_account)
              <address>
              <strong>{{trans('bookings.label_bank_account')}} :</strong><br>
              {!! $booking->course->institute->bank_account !!}<br><br>
            </address>
            @endif
            <address>

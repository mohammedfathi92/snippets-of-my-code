                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="col-md-5">
                                    @if($data->photo && Storage::disk('public')->exists(config('settings.upload_dir')."/".$data->photo))
                                        <div class="col-md-4 col-xs-2 " id="file-{{$data->photo}}">
                                            <div class="panel">
                        ...
                        <hr>
                            ...
                            <div class="col-sm-4">
                                <select name="is_state" id="is_state"  class=" form-control"
                                    ...
                                    <option  value="0"
                                            @if(old('is_state', $data->is_state)== 0) selected @endif> {{ trans('cities.option_city') }}
                                    </option>
                                    <option  value="1"
                                            @if(old('is_state', $data->is_state)== 1) selected @endif> {{ trans('cities.option_state') }}
                                    </option>
                            ...
                            <div class="col-sm-9">
                                <select name="state_id" id="state_id"  class=" form-control"
                                    ...
                                    <option  value="{{ $state->id }}"
                                            @if(old('state_id', $data->state_id)=="{{ $state->id }}") selected @endif>{{ $state->name }}
                                    </option>
                                    @endforeach
                                </select>
                                @if ($errors->has('city'))

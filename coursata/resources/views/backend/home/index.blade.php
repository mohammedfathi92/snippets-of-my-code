...
@section('css')
    <link rel="stylesheet" type="text/css" href="/backend/css/ga-embed.css">
@stop
    ...
    <div class="page-content">
        ...
        <div class="widgets">
            ...
            <div class="panel widget center bgimage"
                 style="background-image:url(/backend/images/widget-backgrounds/02.png);">
                <div class="dimmer"></div>
                <div class="panel-content">
                    <i class="icon-group"></i>
                    <?php $user_count = \Corsata\User::count() ?>
                    <h4>{{ $user_count }} Users</h4>
                    <p>You have {{ $user_count }} active users registered. Click on 'View All Users' to view all your
                        current users.</p>

                    <a href="/{{$backend_uri}}/users" class="btn btn-primary">View All Users</a>
                </div>

            </div>

            <div class="panel widget center bgimage"
                 style="background-image:url(/backend/images/widget-backgrounds/03.png);">
                <div class="dimmer"></div>
                {{--<div class="panel-content">
                    <i class="voyager-news"></i>
                    {{ $post_count = \Corsata\Post::count(); }}
            ...
            <div class="panel widget center bgimage"
                 style="background-image:url(/backend/images/widget-backgrounds/04.png);">
                <div class="dimmer"></div>
                <div class="panel-content">
                    <i class="icon-file-text"></i>
                    <?php $page_count = \Corsata\Page::count(); ?>
                    <h4>{{ $page_count }} Page(s)</h4>
                    <p>You have {{ $page_count }} Pages in your database. Click on 'View All Pages' below to view all
                        pages.</p>

                    <a href="/{{$backend_uri}}/pages" class="btn btn-primary">View All Pages</a>
                </div>
        ...
        @php $google_analytics_client_id = Settings::get("google_analytics_client_id"); @endphp
        @if(isset($google_analytics_client_id) && $google_analytics_client_id)
...
@section('javascript')
    ...
    @if(isset($google_analytics_client_id) && $google_analytics_client_id)
        ...
        <script src="/backend/js/ga-embed/chart.min.js"></script>
        <script src="/backend/js/ga-embed/moment.min.js"></script>
        <!-- Include the ViewSelector2 component script. -->
        <script src="/backend/js/ga-embed/view-selector2.js"></script>
        <!-- Include the DateRangeSelector component script. -->
        <script src="/backend/js/ga-embed/date-range-selector.js"></script>
        <!-- Include the ActiveUsers component script. -->
        <script src="/backend/js/ga-embed/active-users.js"></script>

                ...
                <ul class="nav navbar-nav navbar-right ">
                    ...
                    <li class="dropdown profile">
                        ...
                        <ul class="dropdown-menu dropdown-menu-animated">
                            ...
                            <li>
                                {!! Form::open(['url'=>"/$locale/$backend_uri/logout",'id'=>'logoutForm']).Form::close() !!}
                ...
                <div class="side-menu-container">
                    <div class="navbar-header">
                        <a class="navbar-brand" href="#">
                            ...
                            <div class="title">{{Settings::get('admin_title')}}</div>
                        </a>
                    ...
                    <ul class="nav navbar-nav scrollbar">
                        ...
                        @endcan
                            ...
                            <li class="dropdown @if(Request::segment(3)=="institutes") active @endif">
                                <a href="#institutes-dropdown-list" data-toggle="collapse">
                                    <span class="fa fa-h-square"></span>
                                    <span class="title">{{trans("institutes.link_in_admin_menu")}}</span>
                                </a>
                                <div id="institutes-dropdown-list"
                                     class="panel-collapse collapse @if(Request::segment(3)=="institutes") in @endif"
                                     aria-expanded="true">
                                    <div class="panel-body">
                                        <ul class="nav navbar-nav">
                                          
                                            
                                                <li class="@if(Request::segment(4)=="list"||"courses"||"services") active @endif">
                                                    <a href="{{ url("/$backend_uri/institutes/list") }}">
                                                ...
                                                <li class="@if(Request::segment(4)=="basic-services") active @endif">
                                                    <a href="{{ url("/$backend_uri/institutes/basic-services") }}">
                                                        <span class="fa fa-arrow-circle-o-right"></span>
                                                        <span class="title">{{trans("institutes.basic_services_link_in_admin_menu")}}</span>
                                                    </a>
                        ...
                        @can('show settings')
                            <li class="@if(Request::segment(3)=="compare") active @endif">
                                <a href="{{ url("/$backend_uri/compare/attributes") }}">
                                    <span class="icon icon-edit"></span>
                                    <span class="title">Comprations</span>
                                </a>
                            </li>
                        @endcan
                        ...
                        @endcan
                         ...
                         @can('show housings')
                            <li class="@if(Request::segment(3)=="housings") active @endif">
                                <a href="{{ url("/$backend_uri/housings") }}">
                                    <span class="fa fa-home"></span>
                                    <span class="title">{{trans("housings.link_in_admin_menu")}}</span>
                                </a>
                            </li>
                        @endcan
                         ...
                         @if(Auth::user()->is_advisor == 1)
                            <li class="@if(Request::segment(3)=="advisors") active @endif">
                                <a href="{{ url("/$backend_uri/advisors/students/list") }}">
                                    <span class="fa fa-tripadvisor"></span>
                                    <span class="title">{{trans("bookings.mystudents_link_in_admin_menu")}}</span>
                                </a>
                            </li>
                        @endif

                         @can('show student tips')
                            <li class="@if(Request::segment(3)=="student_tips") active @endif">
                                <a href="{{ url("/$backend_uri/student-tips") }}">
                                    <span class="fa fa-map-signs"></span>
                                    <span class="title">{{trans("student_tips.link_in_admin_menu")}}</span>
                                </a>
                            </li>
                        @endcan
                        ...
                        @endcan
                        @can('show currencies')
                            <li class="@if(Request::segment(3)=="currencies") active @endif">
                                <a href="{{ url("/$backend_uri/currencies") }}">
                                    <span class="icon icon-dollar"></span>
                                    <span class="title">{{trans("currencies.link_backend_menu")}}</span>
                                </a>
                            </li>
                        @endcan

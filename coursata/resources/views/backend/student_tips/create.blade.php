...
@section('page_header')
    <h1 class="page-title">
        <i class="fa fa-dedent"></i> {{trans("student_tips.backend_page_create_header")}} </h1>
@stop
@section("content")
                            ...
                            <div role="tabpanel" class="tab-pane {{$loop->index==0?"active":""}}"
                                ...
                                <div class="form-group {{!$errors->has("description.$localeCode")?:"has-error"}}">
                                    <label for="description"
                                           class=" control-label">{{trans("student_tips.label_description")}}
                                    </label>
                                    <div class="">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-5">
                                  <select name="show_type" id="show_type" class="form-control">
                                          ...
                                          <option value="1" {{old("show_type")== 1 ?"selected":""}}>{{trans("student_tips.show_type_option_public")}}</option>
                                          <option value="2" {{old("show_type")== 2 ?"selected":""}}>{{trans("student_tips.show_type_option_registered")}}</option>
                                          <option value="3" {{old("show_type")== 3 ?"selected":""}}>{{trans("student_tips.show_type_option_student")}}</option>
                                          <option value="4" {{old("show_type")== 4 ?"selected":""}}>{{trans("student_tips.show_type_option_student_registered")}}</option>

...
@section('page_header')
    <h1 class="page-title">
        <i class="icon icon-lock"></i> {{trans("permissions.backend_page_header")}} <a
                href="{{"$locale/$backend_uri"}}/permissions/create"
                class="btn btn-success"><i class="fa fa-plus-circle"></i> {{trans("permissions.btn_add_new")}}</a>
    </h1>
@stop
@section("content")
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="{{"$locale/$backend_uri/permissions"}}" id="delete_form" name="deleteConfirmationForm"
                          method="POST">

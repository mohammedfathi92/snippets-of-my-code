                                ...
                                @if($page->tabs()->count())
                                    @foreach($page->tabs as $row)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                @can('edit pages')
                                                    <a href="{{url("$locale/$backend_uri/pages/$page->id/tabs/{$row->id}/edit")}}"
                                                       class="btn btn-default btn-xs" data-toggle="tooltip"
                                                       data-placement="top" title="{{trans("main.tooltip_edit")}}"><i
                                                                class="fa fa-pencil"></i></a>
                                                @endcan
                                                @can('delete pages')
                                                    <a href="{{url("$locale/$backend_uri/pages/$page->id/pages/tabs/{$row->id}/delete")}}"

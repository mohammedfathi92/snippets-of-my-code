                            ...
                            <div class="col-sm-9">
                                ...
                                @else
                                    <select name="level" class="form-control select2" data-placeholder="Select Access Level">
                                        <option value=""></option>
                                        <option value="1" @if(old('level',$data->level)==1) selected @endif>Manager</option>
                                        <option value="2" @if(old('level',$data->level)==2) selected @endif>Member</option>
                                    </select>
                                    @if ($errors->has('level'))
                                        <span class="help-block">

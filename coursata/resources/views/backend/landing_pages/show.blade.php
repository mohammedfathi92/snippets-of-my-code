    ...
    <div class="topbar" id="topBar">
        <div class="topbarWrapper">
            <div class="container">
                <div class="row">
                    <div class="col-md-10">
                        <p>Start your own <b>site builder SaaS</b> business today! Paid memberships, hosting and 100's of templates</p>
                    </div>
                    <div class="col-md-2">
                        <a class="btn" href="https://sbpro.io/?utm_source=HTMLBuilder&utm_medium=banner&utm_campaign=htmlbuilder">Get SB Pro</a>
                    </div>
                </div>
            </div>
        </div>

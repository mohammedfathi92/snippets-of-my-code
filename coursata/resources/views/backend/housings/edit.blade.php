...
@section('page_header')
    <h1 class="page-title">
        <i class="fa fa-fort-awesome"></i> {{trans("housings.backend_page_update_header")}} ({{$data->name}})</h1>
    <div class="panel pale-default">
        <div class="panel-body"><span
                    class="help-block">{{trans("main.prime_link")}}
                : <code>{!! Html::link("housings/{$data->id}/".str_slug($data->name),"/housings/{$data->id}/".str_slug($data->name)) !!}</code></span>
        </div>
    </div>
@stop
@section("content")
 ...
 <div class="form-group {{$errors->has('type')?"has-error":''}}">
                            ...
                            <div class="col-sm-9">
                                <select name="type" id="type" class="form-control">
                                    <option value="m" {{old("type",$data->type)=="student_house"?"selected":""}}>{{trans("housings.option_type_student_housings")}}</option>
                                            <option value="family" {{old("type",$data->type)=="family"?"selected":""}}>{{trans("users.option_type_family")}}</option>
                                </select>
                        ...
                        <div class="form-group {{$errors->has("beds_num")?"has-error":''}}">
                            ...
                            <div class="col-sm-9">
                                <input type="number" min="1" value="1" name="beds_num" class="form-control" value="{{old("beds_num", $data->beds_num)}}">
                                @if ($errors->has('beds_num'))
                                    <span class="help-block">
                                            <strong>{{ $errors->first('beds_num') }}</strong>
                                        </span>
                    ...
                    <div data-ng-controller="countryCitiesCtrl">
                        <div class="form-group {{$errors->has("country")?"has-error":''}}">
                          ...
                          <div class="form-group {{$errors->has("state")?"has-error":''}}">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="state" class="form-control" value="{{old("state", $data->state)}}">
                                @if ($errors->has('state'))
                                    <span class="help-block">
                        ...
                        <div class="form-group {{$errors->has("address_line1")?"has-error":''}}">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="address_line1" class="form-control" value="{{old("address_line1", $data->address_line1)}}">
                          ...
                          <div class="form-group {{$errors->has("address_line2")?"has-error":''}}">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="address_line2" class="form-control" value="{{old("address_line2", $data->address_line2)}}">
                       ...
                       <div class="form-group {{$errors->has("phone_no1")?"has-error":''}}">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="phone_no1" class="form-control" value="{{old("phone_no1", $data->phone_no1)}}">
                         ...
                         <div class="form-group {{$errors->has("phone_no2")?"has-error":''}}">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="phone_no2" class="form-control" value="{{old("phone_no2", $data->phone_no2)}}">
                                <span class="help-block">
                                            {{trans('main.phone_code_msg')}}
                                        </span>

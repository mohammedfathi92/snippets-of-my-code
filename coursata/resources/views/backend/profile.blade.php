...
@section('css')
    <link rel="stylesheet" type="text/css" href="{{ config('settings.assets_path') }}/css/ga-embed.css">
@stop
...
@section('content')
	...
	<div style="position:relative; z-index:9; text-align:center;">
        ...
        <p>{{ Auth::user()->bio }}</p>
        <a href="{{config("settings.backend_uri")}}/users/{{ Auth::user()->id }}/edit" class="btn btn-primary">Edit My Profile</a>
    </div>
@stop
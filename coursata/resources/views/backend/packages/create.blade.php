                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="tab-general">
                            ...
                            <div class="form-group {{$errors->has("people_count")?"has-error":''}}">
                                ...
                                <div class="col-sm-3">
                                    <input type="number" min="1" value="{{old("people_count")}}"
                                           class="form-control">
                        ...
                        <div role="tabpanel" class="tab-pane" id="tab-details">
                            ...
                            <div data-ng-controller="packageInstitutesCtrl">
                                ...
                                {{--Institutes--}}
                                <h3>{{trans('packages.title_package_institutes')}}</h3>
                                <fieldset class="group-list  well" id="citiesInstitutes">
                                    <legend></legend>
                                    ...
                                    <div class="group-list-item " data-ng-repeat="item in items ">
                                        ...
                                        <div class="col-md-3">
                                            <select name="courses[institute][]" id="institute-<%$index%>" data-ng-model="item.institute"
                                        ...
                                        <div class="col-md-2">
                                            <input type="number" name="courses[days][]" value="1" min="1" class="form-control"
                            ...
                            <div data-ng-controller="packageTransportsCtrl">
                                <h3>{{trans('packages.title_package_transports')}}</h3>
                                {{--Transports--}}
                            ...
                            <div data-ng-controller="packageFlightsCtrl">
                                <h3>{{trans('packages.title_package_flights')}}</h3>
                                {{--Transports--}}

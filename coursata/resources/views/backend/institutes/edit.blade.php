...
@section('page_header')
    <h1 class="page-title">
        <i class="icon icon-study"></i> {{trans("institutes.backend_page_update_header")}} </h1>
@stop
@section("content")
                            ...
                            <div role="tabpanel" class="tab-pane {{$loop->index==0?"active":""}}"
                                ...
                                <div class="form-group {{!$errors->has("address.$localeCode")?:"has-error"}}">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="address[{{$localeCode}}]"
                                               ...
                                               value="{{old("address.$localeCode",$data->{"address:$localeCode"})}}"/>
                                ...
                                <div class=" form-group {{!$errors->has("bank_account.$localeCode")?:"has-error"}}">
                                    ...
                                    <div class="col-sm-9">
                                            ...
                                            >{{old("bank_account.$localeCode",$data->{"bank_account:$localeCode"})}}</textarea>
                    ...
                    <div data-ng-controller="countryCitiesCtrl">
                        ...
                        <div class="form-group {{$errors->has("city")?"has-error":''}}">
                            ...
                            <div class="col-sm-9">
                                    ...
                                    <option value="<%state.id%>" style="background-color: #9bf39b" data-ng-selected="city.id=='{{old('city', $data->city_id)}}'"> <%state.name%>
                                    </option>
                    
                                    <option data-ng-repeat="city in citiesList | where:{state_id: state.id}" value="<%city.id%>"
                                            data-ng-selected="city.id=='{{old('city', $data->city_id)}}'">  - <%city.name%>
                                    </option>
                                </optgroup>
                                <option data-ng-repeat="city in citiesList | where:{state_id: null}" value="<%city.id%>"
                                            data-ng-selected="city.id=='{{old('city', $data->city_id)}}'" style="font-weight: bold;"><%city.name%>
                                    </option>
                                </select>
                                @if ($errors->has('city'))
                                    <span class="help-block">
...
<hr>
              <div class="map_canvas"></div> 
                    ...
                    <div class="form-group {{$errors->has("map_address")?"has-error":''}}">
                        ...
                        <div class="col-md-7 col-sm-9">
                            <input id="geocomplete" class="form-control" type="text" placeholder="Type in an address" value="{{old("map_address",$data->map_address)}}" name="map_address" />
       ...
       <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="lat" class="form-control" type="text" value="{{old("lat", $data->map_lat )}}" style="background-color: #d1f9ce;" readonly>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="lng" class="form-control" type="text" value="{{old("lng, $data->map_lng")}}" style="background-color: #d1f9ce;" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="formatted_address" type="text" value="{{old("formatted_address", $data->map_address)}}" class="form-control"  style="background-color: #d1f9ce;" readonly>
...
<hr>
                    ...
                    <div class="form-group {{$errors->has("phone")?"has-error":''}}">
                        ...
                        <div class="col-sm-9">
                            <textarea type="text" name="phone" class="form-control"
                                      placeholder="{{trans("institutes.holder_phone")}}">{{old("phone",$data->phone)}}</textarea>
                            @if ($errors->has('phone'))
                                <span class="help-block">
                    ...
                    <div class="form-group {{$errors->has("location_type")?"has-error":''}}">
                        ...
                        <div class="col-sm-9">
                            <select name="location_type" id="location_type" class="form-control select2">
                                <option value="1" {{old("location_type",$data->location_type)==1?"selected":""}}>{{trans_choice("institutes.institute_location_type_option",1)}}</option>
                                <option value="2" {{old("location_type",$data->location_type)==2?"selected":""}}>{{trans_choice("institutes.institute_location_type_option",2)}}</option>
                                <option value="3" {{old("location_type",$data->location_type)==3?"selected":""}}>{{trans_choice("institutes.institute_location_type_option",3)}}</option>
                                <option value="4" {{old("location_type",$data->location_type)==4?"selected":""}}>{{trans_choice("institutes.institute_location_type_option",4)}}</option>
                                <option value="5" {{old("location_type",$data->location_type)==5?"selected":""}}>{{trans_choice("institutes.institute_location_type_option",5)}}</option>
                                <option value="6" {{old("location_type",$data->location_type)==6?"selected":""}}>{{trans_choice("institutes.institute_location_type_option",6)}}</option>
                                <option value="7" {{old("location_type",$data->location_type)==7?"selected":""}}>{{trans_choice("institutes.institute_location_type_option",7)}}</option>
                            </select>
        ...
        <div class="col-md-4">
            <div class="panel panel-success">
                <div class="panel-heading text-center">{{trans("institutes.label_video_youtube")}} </div>
                <div class="panel-body">
                ...
                <div class="panel-body">
                    ...
                    >
                        ...
                        <div class="">
                            <div class="">
                                @if($data->logo)
                                    <div class="thumbnail" id="file-{{$data->logo}}" data-ng-if="!logo">
                                        <img src="{{url("files/{$data->logo}")}}" alt=""
                                             class="responsive-img img-thumbnail">
                                        <input type="hidden" name="logo" value="{{$data->logo}}">
                                        <a href="javascript:;" class="btn btn-danger"
                                           ng-click="removeByName('{{$data->logo}}')">{{trans("main.btn_delete")}}</a>
                                    </div>
                                @endif
                                <div ng-repeat="f in photos">
                                    <div class="thumbnail">
       ...
       <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    >
                        <div class="">
                             @if($data->brochures)
                                    <div class="thumbnail" id="file-{{$data->brochures}}" data-ng-if="!brochures">
                                         <img src="/images/file_default.png" height="70" width="70" 
                                             class=" img-thumbnail">
                                        <input type="hidden" name="brochures" value="{{$data->brochures}}">
                                        <a href="javascript:;" class="btn btn-danger"
                                           ng-click="removeByName('{{$data->brochures}}')">{{trans("main.btn_delete")}}</a>
                                    </div>
                                @endif
                            <a id="brochures"

...
class PagesTabsController extends BackendBaseController
{
    ...
    function update(Request $request, $page_id = 0, $id = 0)
    {
        ...
        return redirect($this->data['backend_uri'] . "/pages/$page_id/tabs")
            ->with(['message' => trans("pages.tabs.success_updated"), 'alert-type' => 'success']);
    ...
    function delete(Request $request, $page_id = 0, $id = 0)
    {
        ...
        if ($tab->delete()) {
            ...
            return redirect("/" . $this->data['backend_uri'] . "/pages/$page_id/pages/$page_id/tabs")->with(['message' => trans("pages.tabs.success_deleted"), 'alert-type' => 'success']);
        }
        return redirect("/" . $this->data['backend_uri'] . "/pages/$page_id/pages/$page_id/tabs")->with(['message' => trans("pages.tabs.error_delete"), 'alert-type' => 'error']);

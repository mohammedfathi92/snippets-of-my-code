...
class ArticlesTabsController extends BackendBaseController
{
    ...
    function delete(Request $request, $article_id = 0, $id = 0)
    {
        ...
        if ($tab->delete()) {
            ...
            return redirect("/" . $this->data['backend_uri'] . "/articles/$article_id/articles/$article_id/tabs")->with(['message' => trans("articles.tabs.success_deleted"), 'alert-type' => 'success']);
        }
        return redirect("/" . $this->data['backend_uri'] . "/articles/$article_id/articles/$article_id/tabs")->with(['message' => trans("articles.tabs.error_delete"), 'alert-type' => 'error']);

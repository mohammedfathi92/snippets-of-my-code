...
class CountriesTabsController extends BackendBaseController
{
    ...
    function update(Request $request, $country_id = 0, $id = 0)
    {
        ...
        return redirect($this->data['backend_uri'] . "/countries/$country_id/tabs")
            ->with(['message' => trans("countries.tabs.success_updated"), 'alert-type' => 'success']);
    ...
    function delete(Request $request, $country_id = 0, $id = 0)
    {
        ...
        if ($tab->delete()) {
            ...
            return redirect("/" . $this->data['backend_uri'] . "/countries/$country_id/countries/$country_id/tabs")->with(['message' => trans("countries.tabs.success_deleted"), 'alert-type' => 'success']);
        }
        return redirect("/" . $this->data['backend_uri'] . "/countries/$country_id/countries/$country_id/tabs")->with(['message' => trans("countries.tabs.error_delete"), 'alert-type' => 'error']);

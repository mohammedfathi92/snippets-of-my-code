...
class MenusController extends BackendBaseController
{
    ...
    function store(Request $request)
    {
        ...
        return redirect()->back()->with(['message' => trans("menus.success_created"), 'alert-type' => 'success']);
...
//        return redirect($this->data['backend_uri'] . "/menus")->with(['message' => trans("menus.success_updated"), 'alert-type' => 'success']);
        return redirect()->back()->with(['message' => trans("menus.success_updated"), 'alert-type' => 'success']);

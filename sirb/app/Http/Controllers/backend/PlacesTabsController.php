...
//        return redirect($this->data['backend_uri'] . "/places/$place_id/tabs")->with(['message' => trans("places.tabs.success_created"), 'alert-type' => 'success']);
        return redirect()->back()->with(['message' => trans("places.tabs.success_created"), 'alert-type' => 'success']);
    }
...
//            return redirect("/" . $this->data['backend_uri'] . "/places/$place_id/tabs")->with(['message' => trans("places.tabs.success_deleted"), 'alert-type' => 'success']);
            return redirect()->back()->with(['message' => trans("places.tabs.success_deleted"), 'alert-type' => 'success']);
        }
//        return redirect("/" . $this->data['backend_uri'] . "/places/$place_id/tabs")->with(['message' => trans("places.tabs.error_delete"), 'alert-type' => 'error']);
        return redirect()->back()->with(['message' => trans("places.tabs.error_delete"), 'alert-type' => 'error']);

...
//        return redirect($this->data['backend_uri'] . "/hotels/$hotel_id/tabs")->with(['message' => trans("hotels.tabs.success_created"), 'alert-type' => 'success']);
        return redirect()->back()->with(['message' => trans("hotels.tabs.success_created"), 'alert-type' => 'success']);
    }
...
//        return redirect($this->data['backend_uri'] . "/hotels/$hotel_id/tabs")
        return redirect()->back()->with(['message' => trans("hotels.tabs.success_updated"), 'alert-type' => 'success']);
...
//            return redirect("/" . $this->data['backend_uri'] . "/hotels/$hotel_id/tabs")->with(['message' => trans("hotels.tabs.success_deleted"), 'alert-type' => 'success']);
            return redirect()->back()->with(['message' => trans("hotels.tabs.success_deleted"), 'alert-type' => 'success']);
        }
        return redirect()->back()->with(['message' => trans("hotels.tabs.error_delete"), 'alert-type' => 'error']);

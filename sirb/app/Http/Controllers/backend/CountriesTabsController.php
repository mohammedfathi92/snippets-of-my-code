...
class CountriesTabsController extends BackendBaseController
{
    function index($country_id = 0)
    {
        ...
        return view("backend.countries.tabs.index", $this->data);
    }
...
//        return redirect($this->data['backend_uri'] . "/countries/$country_id/tabs")->with(['message' => trans("countries.tabs.success_created"), 'alert-type' => 'success']);
        return redirect()->back()->with(['message' => trans("countries.tabs.success_created"), 'alert-type' => 'success']);
    }
    ...
    function edit($country_id = 0, $id = 0)
    {
        ...
        if (!$tab) {
            ...
            return redirect()->back()->with(['message' => trans("countries.tabs.id_not_found"), 'alert-type' => 'error']);
        }
...
//        return redirect($this->data['backend_uri'] . "/countries/$country_id/tabs")
        return redirect()->back()->with(['message' => trans("countries.tabs.success_updated"), 'alert-type' => 'success']);
...
//            return redirect("/" . $this->data['backend_uri'] . "/countries/$country_id/tabs")->with(['message' => trans("countries.tabs.success_deleted"), 'alert-type' => 'success']);
            return redirect()->back()->with(['message' => trans("countries.tabs.success_deleted"), 'alert-type' => 'success']);
        }
//        return redirect("/" . $this->data['backend_uri'] . "/countries/$country_id/tabs")->with(['message' => trans("countries.tabs.error_delete"), 'alert-type' => 'error']);
        return redirect()->back()->with(['message' => trans("countries.tabs.error_delete"), 'alert-type' => 'error']);
    ...
    function multiDelete(Request $request)
    {
        ...
        if ($request->input('items') && is_array($request->input('items'))) {
            ...
            return redirect()->back()->with(['message' => trans("countries.tabs.success_multi_delete", ['count' => $deleted]), 'alert-type' => "success"]);
        }

        return redirect()->back()->with(['message' => trans("countries.tabs.error_multi_delete_empty"), 'alert-type' => "warning"]);

...
use Sirb\Mail\NewBookingNotification;
use Sirb\Package;
use Sirb\Room;
use Sirb\Setting;
...
class BookingController extends Controller
{
    ...
    function hotel($id = 0, $slug = null)
    {
        ...
        if (!$hotel) abort(404);//redirect()->back()->with(["message" => "hotels.id_not_found", "alert-type" => "error"]);

        $this->data['hotel'] = $hotel;
        $this->data['title'] = trans("bookings.page_title") . " - " . $hotel->name . " - " . $this->data['title'];
        $this->data['meta_description'] = trans("bookings.page_title") . "  " . $hotel->name . $this->data['meta_description'];
        $this->data['meta_keywords'] = trans("bookings.page_title") . "," . $hotel->name . "," . $this->data['meta_keywords'];
    ...
    function package($id = 0, $slug = null)
    {
        ...
        if (!$package) abort(404);//redirect()->back()->with(["message" => "packages.id_not_found", "alert-type" => "error"]);

        $this->data['package'] = $package;
        $this->data['title'] = trans("bookings.page_title") . " - " . $package->name . " - " . $this->data['title'];
        $this->data['meta_description'] = trans("bookings.page_title") . "  " . $package->name . " " . $this->data['meta_description'];
        $this->data['meta_keywords'] = trans("bookings.page_title") . "," . $package->name . "," . $this->data['meta_keywords'];
    ...
    function room($id = 0, $slug = null)
    {
        ...
        if (!$room) return abort(404);//redirect()->back()->with(["message" => "rooms.id_not_found", "alert-type" => "error"]);
        ...
        $this->data['title'] = trans("bookings.page_title") . " - " . $hotel->name . " " . $room->name . $this->data['title'];
        $this->data['meta_description'] = trans("bookings.page_title") . "  " . $hotel->name . " " . $room->name . $this->data['meta_description'];
        $this->data['meta_keywords'] = trans("bookings.page_title") . "," . $hotel->name . "," . $room->name . "," . $this->data['meta_keywords'];
    ...
    function store(Request $request)
    {
        ...
        $rules = [
            ...
            "package_type" => "required_without_all:hotel_id,package_id",
        ...
        if ($booking_type == "free") {
            ...
            $booking->package_type = $request->input("package_type");
        }

...
class Hotel extends Model
{
    ...
    function scopeInCountry()
    {
     ...
     function comments()
    {
        return $this->hasMany(Comment::class, 'module_id', 'id')->where("status", true)->where('module', 'hotels');
    }

    function reviews()
    {
        return $this->hasMany(Review::class, 'module_id', 'id')->where('module_type', 'hotels');
    }

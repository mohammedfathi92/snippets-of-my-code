                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            {!! Form::open(['url'=>"$locale/$backend_uri/places/services/delete",'name'=>"tableForm",'id'=>'tableForm']) !!}
                                ...
                                @if($place->tabs()->count())
                                    @foreach($place->tabs as $row)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                @can('edit places')
                                                    <a href="{{url("$locale/$backend_uri/places/$place->id/tabs/{$row->id}/edit")}}"
                                                       class="btn btn-default btn-xs" data-toggle="tooltip"
                                                       data-placement="top" title="{{trans("main.tooltip_edit")}}"><i
                                                                class="fa fa-pencil"></i></a>
                                                @endcan
                                                @can('delete places')
                                                    <a href="{{url("$locale/$backend_uri/places/$place->id/tabs/{$row->id}/delete")}}"

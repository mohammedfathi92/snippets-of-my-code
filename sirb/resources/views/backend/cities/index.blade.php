                                ...
                                @if($data)
                                    @foreach($data as $row)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$row->id}}</td>
                                            <td>{{$row->name}}</td>
                                            <td>{{$row->tabs()->count()?Html::link("$locale/$backend_uri/countries/$country->id/cities/$row->id/tabs",trans('tabs.count_tabs',['count'=>$row->tabs()->count()]),['class'=>'btn btn-success']):Html::link("$locale/$backend_uri/countries/$country->id/cities/$row->id/tabs/create",trans('tabs.btn_add_tab'),['class'=>'btn btn-primary'])}}</td>
                                            <td>{!! $row->status?'<span class="label label-success">'.trans("cities.status_active").'</span>':'<span class="label label-danger">'.trans("cities.status_inactive").'</span>' !!}</td>
                                            <td class="text-right">
                                                @can('edit cities')

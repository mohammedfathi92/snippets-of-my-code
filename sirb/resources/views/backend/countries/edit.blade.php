    ...
    <div class="panel pale-default">
        <div class="panel-body">
            <span class="help-block">{{trans("main.prime_link")}}
                : <code>{!! Html::link("country/{$data->id}/".make_slug($data->name),"/country/{$data->id}/".make_slug($data->name)) !!}</code></span>
            <hr>
            <span class="help-block">{{trans("main.prime_link")}}
                : <code>{!! Html::link("country/{$data->id}/".make_slug($data->name)."/guide","/country/{$data->id}/".make_slug($data->name)."/guide") !!}</code></span>
        </div>
    </div>
@stop
@section("content")

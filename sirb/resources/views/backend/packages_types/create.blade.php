...
@section('page_header')
    <h1 class="page-title">
        <i class="fa fa-th-large"></i> {{trans("packages_types.backend_page_create_header")}} </h1>
@stop
@section("content")
                ...
                <div class="panel-body">
                    ...
                    <div data-ng-controller="countryCitiesCtrl">
                        <div class="form-group {{$errors->has("country")?"has-error":''}}">
                            ...
                            <div class="col-sm-9">
                                <select name="country" id="country" class=" form-control select2" data-ng-model="country" data-ng-init="country='{{old("country")}}'">
                                    <option value=""></option>
                                    @if($countries)

...
@section('page_header')
    <h1 class="page-title">
        <i class="fa fa-h-square"></i> {{trans("hotels_services.backend_page_header")}}
        ...
        <div class="row">
            <div class="col-lg-8 col-md-offset-1 col-lg-offset-2">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-collapse collapse @if($errors->count()||(isset($method) && $method=='put')) in @endif" id="newServiceCollapse">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="table-responsive">
                            ...
                            <table id="dataTable" class="table v-middle dataTable">
                                ...
                                @if($services=Sirb\HotelService::all())
                                    @foreach($services as $row)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                @can('edit hotels')
                                                    <a href="{{url("$locale/$backend_uri/hotels/services/{$row->id}/edit")}}"
                                                       class="btn btn-default btn-xs" data-toggle="tooltip"
                                                       data-placement="top" title="{{trans("main.tooltip_edit")}}"><i
                                                                class="fa fa-pencil"></i></a>
                                                @endcan
                                                @can('delete hotels')
                                                    <a href="{{url("$locale/$backend_uri/hotels/services/{$row->id}/delete")}}"

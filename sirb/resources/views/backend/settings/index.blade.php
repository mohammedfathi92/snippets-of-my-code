...
@section('content')
    ...
    <div class="page-content container-fluid">
        ...
        <form action="/{{$locale."/".$backend_uri}}/settings" method="POST" enctype="multipart/form-data">
            <div class="panel">
                @foreach($settings as $setting)
                    <div class="panel-heading">
                        <h3 class="panel-title"> {{ $setting->display_name }} </h3>
                        <div class="panel-actions">
                            <a href="/{{settings('backend_uri')}}/settings/move_up/{{ $setting->id }}"><i
                                        class="sort-icons icon-sort-asc"></i></a>
                            <a href="/{{settings('backend_uri')}}/settings/move_down/{{ $setting->id }}"><i
                    ...
                    <div class="panel-body">
                        ...
                        @elseif($setting->type == "image" || $setting->type == "file")
                            @if(isset( $setting->value ) && !empty( $setting->value ) && !empty(Storage::url($setting->value)))
                                <div class="img_settings_container">
                                    <a href="/{{settings('backend_uri')}}/settings/delete_value/{{ $setting->id }}"
                                       class="icon-x"></a>
        ...
        <div class="panel" id="import-site-data">
            {{--Upload Excel file to import all files data--}}
            <div class="panel-body">
                {!! Form::open(['url'=>"/$locale/$backend_uri/settings/import",'enctype'=>"multipart/form-data"]) !!}
                <h3 class="fileType">Import web site data from Excel file:</h3>

                <input type="file" name="importExcel" accept=".xls,.xlsx">
                <button type="submit" class="btn btn-primary pull-right"
                        onclick="this.form.submit();this.disabled=true">Import Data
                </button>

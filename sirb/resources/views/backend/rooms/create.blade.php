...
@section('page_header')
    <h1 class="page-title">
        <i class="fa fa-h-square"></i> {{trans("rooms.backend_page_create_header")}} </h1>
@stop
@section("content")
    <div class="page-content container-fluid">
                    ...
                    <div class="form-group {{$errors->has("persons")?"has-error":''}}">
                        ...
                        <div class="col-sm-3">
                            <input type="number" name="persons" class="form-control" id="persons" min="1" max="15"
                                   placeholder="" value="{{old("persons",1)}}">
        ...
        <div class="col-md-4">
            <div class="panel panel-success">
                ...
                <div class="panel-body">
                    ...
                    <select name="services[]" multiple id="services" class="select2 form-control">
                        @foreach(\Sirb\RoomService::all() as $service)
            ...
            <div class="panel panel-primary">
                <div class="panel-heading text-center">{{trans("rooms.label_photo")}} <span class="text-danger">*</span>
                </div>
                <div class="panel-body">

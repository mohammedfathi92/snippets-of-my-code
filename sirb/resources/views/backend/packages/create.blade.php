                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="tab-general">
                            ...
                            <div class="form-group {{$errors->has("adults_count")?"has-error":''}}">
                                <label for="adults_count"
                                       class="control-label col-sm-3">{{trans("packages.label_adults_count")}}
                        ...
                        <div role="tabpanel" class="tab-pane" id="tab-details">
                            <div class="form-group {{$errors->has("country")?"has-error":''}}">
                                ...
                                <div class="col-sm-9">
                                    <select name="country" id="country" class=" form-control select2"
                                            ...
                                            data-ng-init="$root.country='{{old("country")}}'">
                                        <option value=""></option>
                                        @if($countries)
                            ...
                            <div data-ng-controller="packageTransportsCtrl">
                                <h3>{{trans('packages.title_package_transports')}} <span
                                            data-ng-show="transportsLoading" class="btn-group-addon"><i
                            ...
                            <div data-ng-controller="packageFlightsCtrl">
                                <h3>{{trans('packages.title_package_flights')}} <span data-ng-show="flightsLoading"
                                                                                      class="btn-group-addon"><i
                                                class="fa fa-spinner fa-pulse fa-fw"></i></span></h3>
                                {{--Transports--}}

...
@section('page_header')
    <h1 class="page-title">
        <i class="fa fa-question-circle-o"></i> {{trans("faq.backend_page_update_header")}} ({{$data->name}})</h1>
@stop
@section("content")
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <select name="type" id="type" class="form-control">
                                <option value=""></option>
                                <option value="hotels" {{old("type",$data->type)=="hotels"?"selected":""}}>{{trans("faq.type_options.hotels")}}</option>
                                <option value="places" {{old("type",$data->type)=="places"?"selected":""}}>{{trans("faq.type_options.places")}}</option>
                                <option value="packages" {{old("type",$data->type)=="packages"?"selected":""}}>{{trans("faq.type_options.packages")}}</option>
                                <option value="countries" {{old("type",$data->type)=="countries"?"selected":""}}>{{trans("faq.type_options.countries")}}</option>
                                <option value="cities" {{old("type",$data->type)=="cities"?"selected":""}}>{{trans("faq.type_options.cities")}}</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">

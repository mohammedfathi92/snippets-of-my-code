...
@section('page_header')
    <h1 class="page-title">
        <i class="fa fa-dedent"></i> {{trans("articles.backend_page_update_header")}} ({{$data->name}})</h1>
@stop
@section("content")
    <div class="page-content container-fluid">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                        ...
                        @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                            <div role="tabpanel" class="tab-pane {{$loop->index==0?"active":""}}"
                                ...
                                <div class="form-group {{!$errors->has("name.$localeCode")?:"has-error"}} ">
                                    <label for="name"
                                           class="col-sm-3 control-label">{{trans("articles.label_name")}}
                                ...
                                <div class="form-group {{!$errors->has("description.$localeCode")?:"has-error"}}">
                                    <label for="description"
                                           class="col-sm-3 control-label">{{trans("articles.label_description")}}
                                    </label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group {{!$errors->has("meta_keywords.$localeCode")?:"has-error"}}">
                                    <label for="meta_keywords"
                                           class="col-sm-3 control-label">{{trans("articles.label_meta_keywords")}}
                                    </label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group {{!$errors->has("meta_description.$localeCode")?:"has-error"}}">
                                    <label for="meta_description"
                                           class="col-sm-3 control-label">{{trans("articles.label_meta_description")}}
                                    </label>
                                    <div class="col-sm-9">
                    ...
                    <div class="form-group {{$errors->has("category")?"has-error":''}}">
                        <label for="category"
                               class="control-label col-sm-3">{{trans("articles.label_category")}}
                        ...
                        <div class="col-sm-9">
                            <select name="category" id="category" class=" form-control select2">
                                <option value=""></option>
                                @if($categories=\Sirb\Category::all())
        ...
        <div class="col-md-4">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading text-center">{{trans("articles.label_photo")}} <span

                            ...
                            <tr>
                                <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                        ...
                                        @if($data->booking_type !='free')
                                            @if(($data->booking_type=="package")&&$data->package_id)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{url("packages/{$data->package_id}/".make_slug($data->package->name))}}"
                                            ...
                                            @if(($data->booking_type=="hotel")&&$data->hotel_id)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{url("hotels/{$data->hotel_id}/".make_slug($data->hotel->name))}}"
                                    ...
                                    <table style="{{ $style['body_action'] }}" align="center" width="100%"
                                        ...
                                        <tr>
                                            <td align="center">
                                                <a href="{{url("/".settings("backend_uri")."/bookings/{$data->id}/show")}}"

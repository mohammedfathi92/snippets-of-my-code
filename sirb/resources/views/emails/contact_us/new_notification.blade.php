                        ...
                        <table style="{{ $style['email-body_inner'] }}" align="center" width="570" cellpadding="0"
                            ...
                            <tr>
                                <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                    <!-- Greeting -->
                                    <h1 style="{{ $style['header-1'] }}"> {!! trans("messages.email_new_message_heading") !!} </h1>

                                    <!-- Intro -->
                                    <p style="{{ $style['paragraph'] }}">
                                        <label for="">{{trans("messages.label_subject")}} :</label>
                                        {!! $data->subject !!}
                                    </p>
                                    <p style="{{ $style['paragraph'] }}">
                                        <label for="">{{trans("messages.label_message")}} :</label>
                                        {!! $data->message !!}
                                    </p>
                                    <!-- Action Button -->
                                    ...
                                    <table style="{{ $style['body_action'] }}" align="center" width="100%"
                                        ...
                                        <tr>
                                            <td align="center">
                                                <a href="{{url("/".settings("backend_uri")."/messages/{$data->id}/show")}}"
                                                   style="{{ $fontFamily }} {{ $style['button'] }} {{ $style['button--blue'] }}"
                                                   class="button"
                                                   target="_blank">
                                                    {!! trans("messages.email_btn_show_message") !!}
                                                </a>
                                            </td>
                                        </tr>
                                    </table>

    ...
    @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
        ...
        @if($localeCode !=LaravelLocalization::getCurrentLocale())
            <link rel="alternate" hreflang="{{$localeCode}}"
                  href="{{\LaravelLocalization::localizeURL("hotels/{$data->id}/".make_slug($data->name),$localeCode)}}"/>
        @endif
    @endforeach
    ...
    <div class="page-title-container">
        <div class="container">
            ...
            <ul class="breadcrumbs pull-right">
                ...
                <li><a href="{{\LaravelLocalization::localizeURL("/hotels")}}">{{trans("hotels.link_hotels")}}</a></li>
...
@section("content")
    <div class="container">
        <div class="col-md-9">
                ...
                <div class="tab-container style1" id="hotel-main-content">
                    <ul class="tabs">
                        ...
                        {{--<li class="pull-right"><a class="button btn-small yellow-bg white-color"
                                                  href="{{\LaravelLocalization::localizeURL("/booking/hotel/{$data->id}/".make_slug($data->name))}}">{{trans("hotels.btn_book_now")}}</a>
                        </li>--}}
                    </ul>
            ...
            <div id="hotel-features" class="tab-container">
                ...
                <ul class="tabs">
                    ...
                    @if($data->rooms->count())
                        ...
                        <li><a href="#" data-target="#hotel_rooms" data-toggle="tab">{{trans("hotels.tab_rooms")}}</a>
                        </li>
                    @endif
                    @if($faq->count())
                    ...
                    @if($data->notes)
                        ...
                        <li><a href="#" data-target="#tab-notes" data-toggle="tab">{{trans("hotels.tab_notes")}}</a>
                        </li>
                    @endif
                                    ...
                                    <article class="box">
                                        <figure class="col-sm-4 col-md-3">
                                            <a class="hover-effect popup-gallery"
                                               href="javascript:;"
                                               data-url="{{\LaravelLocalization::localizeURL("/hotels/ajax/$data->id/rooms/$room->id/gallery")}}"
                                               data-view-slider-modal="{{\LaravelLocalization::localizeURL("/hotels/{$room->id}/".make_slug($room->name))}}"
                                        ...
                                        <div class="details col-xs-12 col-sm-8 col-md-9">
                                            <div>
                                                <div>
                                                    <div class="box-title">
                                                        {{--                                                    <h4 class="title">{!! Html::link("/hotels/$room->id/".make_slug($room->name),$room->name) !!}</h4>--}}
                                            ...
                                            <div>
                                                ...
                                                <div class="action-section">
                                                    <a href="{{route('booking.room',['id'=>$room->id,'slug'=>make_slug($room->name)])}}?rel=book_now"
                                                       title=""
            ...
            <!-- Comments $ reviews-->
            @include('frontend.parts.comments_reviews', ['module' => "hotels", 'module_data'=>$data])
            ...
            <article class="detailed-logo">
                ...
                <div class="details">
                    ...
                    <div class="feedback clearfix">
                        <div title="{{trans_choice("hotels.hotel_stars_option",$data->stars)}}"
                    ...
                    @foreach($related->get() as $hotel)
                        <article class="box">
                            <figure>
                                ...
                                <a href="{{\LaravelLocalization::localizeURL("hotels/$hotel->id/".make_slug($hotel->name))}}">

    ...
    @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
        ...
        @if($localeCode !=LaravelLocalization::getCurrentLocale())
            <link rel="alternate" hreflang="{{$localeCode}}"
                  href="{{\LaravelLocalization::localizeURL("booking/hotel/{$hotel->id}/".make_slug($hotel->name),$localeCode)}}"/>
        @endif
    @endforeach
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 col-md-5">
                            <div class="col-md-6 col-sm-6">
                                <label for="">{{trans("bookings.label_num_rooms")}}</label>
                                <div class="">
                                    <input type="number" name="num_rooms" class="input-text full-width"
                                           value="{{old("num_rooms",1)}}"
                                           min="1"
                                           max="100"
                                           placeholder="{{trans("bookings.label_num_rooms")}}"/>

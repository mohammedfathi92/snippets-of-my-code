    ...
    @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
        ...
        @if($localeCode !=LaravelLocalization::getCurrentLocale())
            <link rel="alternate" hreflang="{{$localeCode}}"
                  href="{{\LaravelLocalization::localizeURL("booking/hotel/{$room->id}/".make_slug($room->name),$localeCode)}}"/>
        @endif
    @endforeach
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6 col-md-5 {{$errors->has("room_id")?"has-error":''}}">
                            ...
                            @if($room)
                                ...
                                <div class="col-md-9">
                                    <a href="{{\LaravelLocalization::localizeURL("/hotels/$hotel->id/".make_slug($room->name))}}"

    ...
    @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
        ...
        @if($localeCode !=LaravelLocalization::getCurrentLocale())
            <link rel="alternate" hreflang="{{$localeCode}}"
                  href="{{\LaravelLocalization::localizeURL("testimonials/create",$localeCode)}}"/>
        @endif
    @endforeach
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6 col-md-6 ">
                            ...
                            <div class=""
                                 ...
                                 data-upload-url="{{\LaravelLocalization::localizeURL("$locale/upload")}}"
                                 data-resize="200,150"
            ...
            <div class="travelo-box filters-container faq-topics">
                ...
                <ul class="triangle filters-option">
                    <li class="{{(!Request::segment(3))?"active":""}}"><a
                                href="{{\LaravelLocalization::localizeURL("testimonials")}}">{{trans("testimonials.title_all_destinations")}}</a></li>

        ...
        <section id="content">
            <div class="container">
                <div id="main">
                    ...
                    <div class="text-center yellow-color box" style="font-size: 2em; font-weight: 150; line-height: 1em;">{{trans('auth.reset_password')}}</div>
                    <p class="light-blue-color block" style="font-size: 1.3333em;">{{trans('auth.reset_password_send_email')}}</p>
                    <div class="col-sm-8 col-md-6 col-lg-5 no-float no-padding center-block">
                         <form class="login-form" role="form" method="POST" action="{{ url('/'.$locale.'/password/email') }}">
                                {{ csrf_field() }}
                            ...
                            <button type="submit" class="btn-large full-width sky-blue1">{{trans("auth.btn_send")}}</button>

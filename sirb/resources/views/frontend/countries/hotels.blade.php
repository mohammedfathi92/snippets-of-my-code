    ...
    @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
        ...
        @if($localeCode !=LaravelLocalization::getCurrentLocale())
            <link rel="alternate" hreflang="{{$localeCode}}"
                  href="{{\LaravelLocalization::localizeURL("country/{$country->id}/".make_slug($country->name)."/hotels",$localeCode)}}"/>
        @endif
    @endforeach
    ...
    <div class="page-title-container">
        <div class="container">
            <div class="page-title pull-left">
                <h2 class="entry-title">{{trans("cities.page_title_country_hotels",['country'=>$country->name])}}</h2>
            </div>
                                ...
                                <div class="col-sm-6 col-md-4">
                                    <article class="box" style="min-height: 100px">
                                        ...
                                        <figure>
                                            ...
                                            <a href="{{\LaravelLocalization::localizeURL("city/$city->/".make_slug($city->name)."/hotels")}}">
                                        ...
                                        <div class="details">
                                            ...
                                            <h4 class="box-title"><a
                                                        href="{{\LaravelLocalization::localizeURL("city/$city->id/".make_slug($city->name)."/hotels")}}">{{trans("hotels.country_cities_hotels_item",['city'=>$city->name])}}</a>
                                                <small>
                                            ...
                                            <div class="action">
                                                <a class="button btn-small"
                                                   href="{{\LaravelLocalization::localizeURL("city/$city->id/".make_slug($country->name)."/hotels")}}">{{trans("cities.btn_show_hotels")}}</a>
                                            </div>

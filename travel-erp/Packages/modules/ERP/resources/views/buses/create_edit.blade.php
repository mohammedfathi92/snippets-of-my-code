...
@section('content_header')
    @component('components.content_header')
        ...
        @endslot
        @slot('breadcrumb')
            {{ Breadcrumbs::render('bus_create_edit') }}
        @endslot
    @endcomponent
@endsection
...
@section('content')
    <div class="row">
        <div class="col-md-12">
            @component('components.box')
                {!! Form::model($bus, ['url' => url($resource_url.'/'.$bus->hashed_id),'method'=>$bus->exists?'PUT':'POST','files'=>true,'class'=>'ajax-form']) !!}
                <div class="row form-group">
                   ...
                   {{-- translation row --}}
                    ...
                    <div class="{{ $code=='ar'?'active':'' }} tab-pane" id="lang_{{ $code }}">
                        ...
                        {!! PackagesForm::text('name['.$code.']','ERP::attributes.main.name',true, $bus->getTranslation('name', $code)) !!}

                        {!! PackagesForm::textarea('description['.$code.']',trans('ERP::attributes.main.description'),false, $bus->getTranslation('description', $code)) !!}
                        {!! PackagesForm::text('notes['.$code.']','ERP::attributes.main.note',false, $bus->getTranslation('notes', $code)) !!}
 ...
 <div class="col-md-4" >
                        ...
                        <div class="col-md-4">
                            {!! PackagesForm::select('city_id','ERP::attributes.hotel.city', \ERP::getCitiesListByCountry($bus->country_id),true,null, ['id' => 'row_city_id'], 'select2') !!}
                     </div>
                     <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                     ...
                     <div class="row">
                       <div class="col-md-4">
                          {!! PackagesForm::radio('status','ERP::attributes.main.status',true, trans('ERP::attributes.main.status_options'), $bus->exists?$bus->status:1) !!}
                          </div>
                     </div>

...
@section('content_header')
    @component('components.content_header')
        ...
        @endslot
        @slot('breadcrumb')
            {{ Breadcrumbs::render('ferryprice_create_edit') }}
        @endslot
    @endcomponent
@endsection
    ...
    <div class="row">
        <div class="col-md-12">
            @component('components.box',['box_title'=>trans('ERP::attributes.main.general_info')])
                {!! Form::model($ferry_price, ['url' => url($resource_url.'/'.$ferry_price->hashed_id),'method'=>$ferry_price->exists?'PUT':'POST','files'=>true,'class'=>'ajax-form']) !!}
                <div class="row form-group">
                    ...
                    <div class="{{ $code=='ar'?'active':'' }} tab-pane" id="lang_{{ $code }}">
                        ...
                        {!! PackagesForm::text('name['.$code.']','ERP::attributes.main.name',true, $ferry_price->getTranslation('name', $code)) !!}

                       
                        {!! PackagesForm::textArea('notes['.$code.']','ERP::attributes.main.note',false, $ferry_price->getTranslation('notes', $code)) !!}
                ...
                <div class="row">
                             <div class="col-md-4">
                                {!! PackagesForm::select('transport_id','ERP::attributes.order.ferry', \ERP::getFerriesList(),true,null,[],'select2') !!}
                             </div>
                     ...
                     <div class="row">
                         ...
                         <div class="col-md-4" >
                          ...
                          <div class="col-md-4">
                            ...
                            {!! PackagesForm::select('from_city_id','ERP::attributes.transport.from_city', \ERP::getCitiesListByCountry($ferry_price->from_country_id),true,null, ['id' => 'row_from_city'], 'select2') !!}
                            </div>
                         </div>
                        </div> 
                      ...
                      <div class="row">
                         ...
                         <div class="col-md-4" >
                          ...
                          <div class="col-md-4">
                            ...
                            {!! PackagesForm::select('to_city_id','ERP::attributes.transport.to_city', \ERP::getCitiesListByCountry($ferry_price->to_country_id),true,null,  ['id' => 'row_to_city'], 'select2') !!}
                            </div>
                         </div>
                        </div> 
                    ...
                    <div class="row">
                            ...
                            <div class="row">
    <div class="col-md-4">
        {!! PackagesForm::radio('status','ERP::attributes.main.status',true, trans('ERP::attributes.main.status_options'), $ferry_price->exists?$ferry_price->status:1) !!}
                ...
                {!! PackagesForm::customFields($ferry_price) !!}

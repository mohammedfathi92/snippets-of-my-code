    ...
    <div class="row">
        <div class="col-md-12">
            @component('components.box',['box_title'=>trans('ERP::attributes.order.customer_data')])
                {!! Form::model($order, ['url' => url('erp/packages/duplicates/hotels/'.$order->hashed_id),'method'=>'POST','files'=>true,'class'=>'ajax-form']) !!}
            ...
            @component('components.box',['box_title'=>trans('ERP::attributes.order.orders')])
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        {!! PackagesForm::date('dates[entry_date]','ERP::attributes.order.entry_date',false) !!}
                    </div>
                
                    <div class="form-group col-md-6">
                        {!! PackagesForm::date('dates[leave_date]','ERP::attributes.order.leave_date',false) !!}
                    </div>
                    
                </div>
                <div class="row">
                    <div class="form-group col-md-6">
                        {!! PackagesForm::text('dates[reserve_code]','ERP::attributes.order.reserve_code',false) !!}
                    </div>
                </div>

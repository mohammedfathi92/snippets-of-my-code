    ...
    <div class="row">
        <div class="col-md-12">
            @component('components.box',['box_title'=>trans('ERP::attributes.order.customer_data')])
                {!! Form::model($order, ['url' => url('erp/packages/duplicates/flights/'.$order->hashed_id),'method'=>'POST','files'=>true,'class'=>'ajax-form']) !!}
            ...
            @component('components.box',['box_title'=>trans('ERP::attributes.order.orders')])
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        {!! PackagesForm::text('dates[confirmed_reserve_code]','ERP::attributes.order.confirmed_reserve_code',false) !!}
                    </div>

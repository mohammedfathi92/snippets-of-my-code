    ...
    <div class="row">
        <div class="col-md-12">
            @component('components.box',['box_title'=>trans('ERP::attributes.order.customer_data')])
                {!! Form::model($order, ['url' => url('erp/orders/duplicates/transports/'.$order->hashed_id),'method'=>'POST','files'=>true,'class'=>'ajax-form']) !!}
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        {!! PackagesForm::date('dates[date]','ERP::attributes.order.date',false) !!}
                    </div>
                
                    <div class="form-group col-md-6">
                        {!! PackagesForm::text('dates[time]','ERP::attributes.order.time',false) !!}
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-6">
                        {!! PackagesForm::text('dates[transport_order]','ERP::attributes.order.transport_order',false) !!}
                    </div>

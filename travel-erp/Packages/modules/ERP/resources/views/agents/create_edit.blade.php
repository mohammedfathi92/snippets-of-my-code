...
@section('content')
    <div class="row">
      <div class="col-md-12">
                ...
                {!! Form::model($agent, ['url' => url($resource_url.'/'.$agent->hashed_id),'method'=>$agent->exists?'PUT':'POST','files'=>true,'class'=>'ajax-form']) !!}
<div class="row">
           <div class="col-md-8">
            @component('components.box', ['box_title'=>__('ERP::attributes.titles.account_details')])     
                ...
                <div class="row form-group">
                    ...
                    <div class="{{ $code=='ar'?'active':'' }} tab-pane" id="lang_{{ $code }}">
                        ...
                        {!! PackagesForm::text('translated_name['.$code.']','ERP::attributes.main.name',true, $agent->getTranslation('translated_name', $code)) !!}

                        
                    {!! PackagesForm::textarea('user_notes['.$code.']','ERP::attributes.main.note',false, $agent->getTranslation('user_notes', $code)) !!}
                ...
                @php
                $userCode = ERP::codeGenerator('agent','int', 7);
                @endphp

                     <div class="row">
                        <div class="col-md-4">
                            {!! PackagesForm::text('user_code','ERP::attributes.main.reg_code',true, $agent->user_code?:$userCode) !!}   
                        </div>
                         <div class="col-md-4" >
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            {!! PackagesForm::select('city_id','ERP::attributes.hotel.city', \ERP::getCitiesListByCountry($agent->country_id),true,null, ['id' => 'row_city_id'], 'select2') !!}
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                          {!! PackagesForm::number('commission_room', 'ERP::attributes.main.commission_room' ) !!}
                           
                            
                        </div>
                        <div class="col-md-4">
                          {!! PackagesForm::number('commission_tour', 'ERP::attributes.main.commission_tour' ) !!}
                           
                            
                        </div>
                        <div class="col-md-4">
                          {!! PackagesForm::number('commission_ticket', 'ERP::attributes.main.commission_ticket' ) !!}
...
<hr>
            ...
            <div class="col-md-12" >
                            {!! PackagesForm::select('category_id','ERP::attributes.accounts.category', \ERP::getCategoriesByType('agents'),false,null,[], 'select2') !!}
                         </div>
                     ...
                     <div class="col-md-12">
                        ...
                        @if($agent->exists && $agent->getFirstMedia('user-picture'))
                        <img src="{{ $agent->picture_thumb }}" class="img-responsive" style="max-width: 100%; max-height: 250px"
                             alt="User Picture"/>
                    ...
                    <div class="col-md-12">
                       ...
                       {!! PackagesForm::radio('status','ERP::attributes.main.status',true, trans('ERP::attributes.main.status_options'), $agent->exists?$agent->status:1) !!}
    ...
    @include('ERP::partials.create_account', ['user' => $agent, 'user_type' => 'agent'])     
...
<div class="col-md-8">
        @component('components.box')
                ...
                {!! PackagesForm::customFields($agent) !!}

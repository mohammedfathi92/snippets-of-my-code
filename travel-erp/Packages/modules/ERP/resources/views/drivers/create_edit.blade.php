...
@section('content')
    <div class="row">
      <div class="col-md-12">
                ...
                {!! Form::model($driver, ['url' => url($resource_url.'/'.$driver->hashed_id),'method'=>$driver->exists?'PUT':'POST','files'=>true,'class'=>'ajax-form']) !!}
<div class="row">
           <div class="col-md-8">
            @component('components.box', ['box_title'=>__('ERP::attributes.titles.account_details')])     
                ...
                <div class="row form-group">
                    ...
                    <div class="{{ $code=='ar'?'active':'' }} tab-pane" id="lang_{{ $code }}">
                        ...
                        {!! PackagesForm::text('translated_name['.$code.']','ERP::attributes.main.name',true, $driver->getTranslation('translated_name', $code)) !!}

                        
                    {!! PackagesForm::textarea('user_notes['.$code.']','ERP::attributes.main.note',false, $driver->getTranslation('user_notes', $code)) !!}
                ...
                @php
                $userCode = ERP::codeGenerator('driver','int', 7);
                @endphp

                     <div class="row">
                        <div class="col-md-4">
                            {!! PackagesForm::text('user_code','ERP::attributes.main.reg_code',true, $driver->user_code?:$userCode) !!}   
                        </div>
                         <div class="col-md-4" >
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4">
                            {!! PackagesForm::select('city_id','ERP::attributes.hotel.city', \ERP::getCitiesListByCountry($driver->country_id),true,null, ['id' => 'row_city_id'], 'select2') !!}
          ...
          <div class="row">
                         <div class="col-md-3" >
                             {!! PackagesForm::number('salary[monthly_salary]','ERP::attributes.main.monthly_salary',false,$salary->monthly_salary, ['step'=> ".01", 'placeholder' => '0.00']) !!}
                         </div>
                         <div class="col-md-3" >
                            {!! PackagesForm::number('salary[hourly_salary]','ERP::attributes.main.hourly_salary',false,$salary->hourly_salary, ['step'=> ".01", 'placeholder' => '0.00']) !!} 
                         </div>
                        <div class="col-md-3">
                            {!! PackagesForm::number('salary[per_trip_salary]','ERP::attributes.main.per_trip_salary',false,$salary->per_trip_salary, ['step'=> ".01", 'placeholder' => '0.00']) !!} 
                        </div>
                        <div class="col-md-3">
                            {!! PackagesForm::number('salary[fixed_allowance]','ERP::attributes.main.fixed_allowance',false,$salary->fixed_allowance, ['step'=> ".01", 'placeholder' => '0.00']) !!} 
                        </div>
...
<hr>
            ...
            <div class="col-md-12" >
                            {!! PackagesForm::select('category_id','ERP::attributes.accounts.category', \ERP::getCategoriesByType('drivers'),false,null,[], 'select2') !!}
                         </div>
                     ...
                     <div class="col-md-12">
                        ...
                        @if($driver->exists && $driver->getFirstMedia('user-picture'))
                        <img src="{{ $driver->picture_thumb }}" class="img-responsive" style="max-width: 100%; max-height: 250px"
                             alt="User Picture"/>
                    ...
                    <div class="col-md-12">
                       ...
                       {!! PackagesForm::radio('status','ERP::attributes.main.status',true, trans('ERP::attributes.main.status_options'), $driver->exists?$driver->status:1) !!}
    ...
    @include('ERP::partials.create_account', ['user' => $driver, 'user_type' => 'driver'])     
...
<div class="col-md-8">
        @component('components.box')
                ...
                {!! PackagesForm::customFields($driver) !!}

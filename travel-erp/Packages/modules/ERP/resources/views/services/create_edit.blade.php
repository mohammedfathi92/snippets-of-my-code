...
@section('content_header')
    @component('components.content_header')
        ...
        @endslot
        @slot('breadcrumb')
            {{ Breadcrumbs::render('erpservice_create_edit') }}
        @endslot
    @endcomponent
@endsection
    ...
    <div class="row">
        <div class="col-md-12">
            @component('components.box')
                {!! Form::model($service, ['url' => url($resource_url.'/'.$service->hashed_id),'method'=>$service->exists?'PUT':'POST','files'=>true,'class'=>'ajax-form']) !!}
                <div class="row form-group">
                    <div class="col-md-10 col-md-offset-1">
                    <!-- service service fields here-->
                   ...
                   {{-- translation row --}}
                    ...
                    <div class="{{ $code=='ar'?'active':'' }} tab-pane" id="lang_{{ $code }}">
                        ...
                        {!! PackagesForm::text('name['.$code.']','ERP::attributes.main.name',true, $service->getTranslation('name', $code)) !!}

                        {!! PackagesForm::textarea('description['.$code.']',trans('ERP::attributes.main.description'),false, $service->getTranslation('description', $code)) !!}
                        {!! PackagesForm::text('notes['.$code.']','ERP::attributes.main.note',false, $service->getTranslation('notes', $code)) !!}
                    ...
                    <div class="col-md-4" >
                        ...
                        <div class="col-md-4">
                            {!! PackagesForm::select('city_id','ERP::attributes.hotel.city', \ERP::getCitiesListByCountry($service->country_id),true,null, ['id' => 'row_city_id'], 'select2') !!}
                     </div>
                     </div>
                     <div class="row">
                        <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                     ...
                     <div class="row">
                       <div class="col-md-4">
                          {!! PackagesForm::radio('status','ERP::attributes.main.status',true, trans('ERP::attributes.main.status_options'), $service->exists?$service->status:1) !!}
                          </div>
                     </div>
                ...
                {!! PackagesForm::customFields($service) !!}

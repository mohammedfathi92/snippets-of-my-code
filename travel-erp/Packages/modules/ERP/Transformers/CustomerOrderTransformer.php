...
class CustomerOrderTransformer extends BaseTransformer
{
    ...
    public function transform(Order $order)
    {
      ...
      $final_prepay_percent = $flights_prepay_percent + $hotels_prepay_percent + $transports_prepay_percent;
        ...
        return [
            'id' => $order->id,
            'customer_code' => $order->customer?$order->customer->code:'',
            'order_code' => $order->order_code,
            'name' => $order->customer?$order->customer->name:'',
            'phone_number' => $order->customer?$order->customer->phone_number:'',

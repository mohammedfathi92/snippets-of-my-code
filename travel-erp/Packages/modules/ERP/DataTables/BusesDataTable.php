...
use Packages\Modules\ERP\Transformers\BusTransformer;
use Yajra\DataTables\EloquentDataTable;

class BusesDataTable extends BaseDataTable
{
    /**
    ...
    {
        $this->setResourceUrl(config('erp.models.bus.resource_url'));

        $dataTable = new EloquentDataTable($query);

        return $dataTable->setTransformer(new BusTransformer());
    }
    ...
    {
        return $model->newQuery()->where('transport_type','bus');
    }

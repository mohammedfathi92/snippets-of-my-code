...
use Packages\Modules\ERP\Transformers\FlightPriceTransformer;
use Yajra\DataTables\EloquentDataTable;

class FlightPricesDataTable extends BaseDataTable
{
    /**
    ...
    {
        $this->setResourceUrl(config('erp.models.flightprice.resource_url'));

        $dataTable = new EloquentDataTable($query);

        return $dataTable->setTransformer(new FlightPriceTransformer());
    }

    /**
     * Get query source of dataTable.
     * @param Flight_Type $model_type
     * @param Flight_Price $model_price
     * @return \Illuminate\Database\Eloquent\Builder|static
     */
    public function query(FlightPrice $model )
    {
    ...
    //          'from_country_id' => ['title' => trans('ERP::attributes.transport.from_country'), 'class' => 'col-md-2', 'type' => 'select2', 'options' => ERP::getCountriesList(), 'condition' => 'like', 'active' => true],
    //          'from_city_id' => ['title' => trans('ERP::attributes.transport.from_city'), 'class' => 'from_country_filter col-md-2', 'type' => 'select2', 'options' => ERP::getCitiesList(), 'condition' => 'like', 'active' => true],

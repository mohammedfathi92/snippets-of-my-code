...
use Packages\Modules\ERP\Transformers\AirportTransformer;
use Yajra\DataTables\EloquentDataTable;

class AirportsDataTable extends BaseDataTable
{
    /**
    ...
    {
        $this->setResourceUrl(config('erp.models.airport.resource_url'));

        $dataTable = new EloquentDataTable($query);

        return $dataTable->setTransformer(new AirportTransformer());
    }

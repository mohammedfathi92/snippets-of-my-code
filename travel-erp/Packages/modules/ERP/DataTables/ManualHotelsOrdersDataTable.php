...
use Packages\Modules\ERP\Transformers\ManualHotelOrderTransformer;
use Yajra\DataTables\EloquentDataTable;

class ManualHotelsOrdersDataTable extends BaseDataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->setTransformer(new ManualHotelOrderTransformer());
    }
    ...
    {
        return $model->newQuery()->where('price_type', "manual");
    }
     ...
     protected function getFilters()
    {
       return [
            ...
            'rooms_num'     => ['title' => trans('ERP::attributes.order.rooms_num'), 'class' => 'col-md-2', 'type' => 'number', 'condition' => 'like', 'active' => true],

...
use Packages\Modules\ERP\Transformers\CustomerTransformer;
...
class CustomersDataTable extends BaseDataTable
{
    ...
    {
        $this->setResourceUrl(config('erp.models.customer.resource_url'));
     ...
     */
    public function query(UserErp $model)
    {
        return $model->newQuery()->where('user_type', 'client');
    }
 ...
 // 'name_en' => ['searchable'=>false , 'orderable'=>false,'title' => trans('ERP::attributes.main.nameAr')],
        return [
            'id' => ['visible' => false],
            ...
            'nick_name' => ['title' => trans('ERP::attributes.users.nick_name_ar')],

            'nick_name_en' => ['title' => trans('ERP::attributes.users.nick_name_en')],

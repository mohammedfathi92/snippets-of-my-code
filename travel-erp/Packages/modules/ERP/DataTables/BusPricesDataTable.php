...
use Packages\Modules\ERP\Transformers\BusPriceTransformer;
use Yajra\DataTables\EloquentDataTable;

class BusPricesDataTable extends BaseDataTable
{
    /**
    ...
    {
        $this->setResourceUrl(config('erp.models.busprice.resource_url'));

        $dataTable = new EloquentDataTable($query);

        return $dataTable->setTransformer(new BusPriceTransformer());
    }

    /**
     * Get query source of dataTable.
     * @param Bus_Type $model_type
     * @param Bus_Price $model_price
     * @return \Illuminate\Database\Eloquent\Builder|static
     */
    public function query(BusPrice $model )
    {

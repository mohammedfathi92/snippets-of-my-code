...
use Packages\Modules\ERP\Transformers\AirlineTransformer;
use Yajra\DataTables\EloquentDataTable;

class AirlinesDataTable extends BaseDataTable
{
    /**
    ...
    {
        $this->setResourceUrl(config('erp.models.airline.resource_url'));

        $dataTable = new EloquentDataTable($query);

        return $dataTable->setTransformer(new AirlineTransformer());
    }
    ...
    {
        return $model->newQuery()->where('transport_type','airline');
    }

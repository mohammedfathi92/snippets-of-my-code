...
use Packages\Modules\ERP\Transformers\JourneyTransformer;
use Yajra\DataTables\EloquentDataTable;

class JourneysDataTable extends BaseDataTable
{
    /**
    ...
    {
        $this->setResourceUrl(config('erp.models.journey.resource_url'));

        $dataTable = new EloquentDataTable($query);

        return $dataTable->setTransformer(new JourneyTransformer());
    }
     ...
     */
    public function query(Journey $model)
    {

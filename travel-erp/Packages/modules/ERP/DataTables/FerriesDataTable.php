...
use Packages\Modules\ERP\Transformers\FerryTransformer;
use Yajra\DataTables\EloquentDataTable;

class FerriesDataTable extends BaseDataTable
{
    /**
    ...
    {
        $this->setResourceUrl(config('erp.models.ferry.resource_url'));

        $dataTable = new EloquentDataTable($query);

        return $dataTable->setTransformer(new FerryTransformer());
    }
     ...
     */
    public function query(Ferry $model)
    {
        return $model->newQuery()->where('transport_type','ferry');
    }

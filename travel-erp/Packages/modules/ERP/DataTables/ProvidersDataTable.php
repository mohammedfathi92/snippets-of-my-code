...
use Packages\Modules\ERP\Transformers\ProviderTransformer;
...
class ProvidersDataTable extends BaseDataTable
{
    ...
    {
        $this->setResourceUrl(config('erp.models.provider.resource_url'));
    ...
    {
        return $model->newQuery()->where('user_type', 'provider');
    }

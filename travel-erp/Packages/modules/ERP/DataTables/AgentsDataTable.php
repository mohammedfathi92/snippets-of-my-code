...
use Packages\Modules\ERP\Transformers\AgentTransformer;
...
class AgentsDataTable extends BaseDataTable
{
    ...
    {
        $this->setResourceUrl(config('erp.models.agent.resource_url'));

        $dataTable = new EloquentDataTable($query);

        return $dataTable->setTransformer(new AgentTransformer());
    }
    ...
    {
        return $model->newQuery()->where('user_type', 'agent');
    }

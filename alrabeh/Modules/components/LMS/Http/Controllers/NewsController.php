...
use Modules\Components\LMS\DataTables\NewsDataTable;
use Modules\Components\LMS\Http\Requests\NewsRequest;
...
class NewsController extends BaseController
{
    ...
    {
        $this->resource_url = config('lms.models.news.resource_url');
        $this->title = 'LMS::module.news.title';
        $this->title_singular = 'LMS::module.news.title_singular';
    ...
    {
        return $dataTable->render('LMS::news.index');
    }
    ...
    public function create(NewsRequest $request)
    {
        ...
        return view('LMS::news.create_edit')->with(compact('news'));
    }
    ...
    {
        $this->setViewSharedData(['title_singular' =>trans('Modules::labels.update_title', ['title' => $news->title])]);

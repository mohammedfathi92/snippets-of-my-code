...
<div class="login-wrap">
	<div >
		<h4 class="login-title">تسجيل الدخول للموقع</h4>
	</div>
    <div class="login-content ">
        <div class="content-bottom">
            <form action="#" method="post">
                <div class="field-group">
                    ...
                    <div class="login-field">
                        <input name="text1" id="text1" type="text" placeholder="{{__('developnet-lms::attributes.inputs.input_name')}}" required>
                    </div>
                </div>
                <div class="field-group">
                ...
                <div class="field-group">
                    <div class="check">
                        <label class="checkbox ">
                            ...
                            <i> </i>@lang('developnet-lms::labels.spans.span_show_password')</label>
                    </div>
                ...
                <div class="login-field">
                    <input id="saveForm" name="saveForm" type="submit" value="{{__('developnet-lms::attributes.inputs.input_sign_in')}}"/>
                </div>
                <ul class="list-login">
                    <li class="switch-login">
                        <label class="switch">
                            ...
                            @lang('developnet-lms::labels.spans.span_keep_login')
                        </label>
                    </li>
                    <li>
            ...
            <div class="goto-toggle">
	        	<center>
	        		<a href="signup.html">
                    @lang('developnet-lms::labels.links.link_new_account')</a>
	        	</center>
	        </div>
        </div>
    </div>

...
-- Dumping data for table alrabeh.lms_certificate_templates: ~1 rows (approximately)
...
INSERT INTO `lms_questions` (`id`, `title`, `preview_video`, `content`, `duration`, `duration_unit`, `points`, `question_type`, `question_explanation`, `question_hint`, `difficulty`, `show_check_answer`, `skip_question`, `show_hint`, `allow_comments`, `status`, `type`, `options`, `created_by`, `updated_by`, `deleted_at`, `created_at`, `updated_at`) VALUES
	(1, 'ومن هنا وجب على المصمم أن يضع نصوصا مؤقتة على التصميم ليظهر للعميل الشكل كاملًا', NULL, 'ومن هنا وجب على المصمم أن يضع نصوصا مؤقتة على التصميم ليظهر للعميل الشكل كاملًا ومن هنا وجب على المصمم أن يضع نصوصا مؤقتة على التصميم ليظهر للعميل الشكل كاملًا', NULL, 'minute', '4', 'true_false', 'ومن هنا وجب على المصمم أن يضع نصوصا مؤقتة على التصميم ليظهر للعميل الشكل كاملًا', 'ومن هنا وجب على المصمم أن يضع نصوصا مؤقتة على التصميم ليظهر للعميل الشكل كاملًا', 1, 0, 0, 0, 0, 1, 'standard', NULL, 1, 1, NULL, '2018-09-04 14:07:05', '2018-09-04 14:07:05'),
	(2, 'ذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى', NULL, 'ذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى ذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى', NULL, 'minute', '5', 'multi_choice', NULL, NULL, 1, 0, 0, 0, 0, 1, 'standard', NULL, 1, 1, NULL, '2018-09-04 14:08:10', '2018-09-04 14:08:10'),
	(3, 'هذا النص يمكن أن يتم تركيبه على أي تصميم دون مشكلة فلن يبدو وكأنه نص منسوخ،', NULL, 'هذا النص يمكن أن يتم تركيبه على أي تصميم دون مشكلة فلن يبدو وكأنه نص منسوخ، غير منظم، غير منسق، أو حتى غير مفهوم. لأنه مازال نصًا بديلًا ومؤقتًا.', NULL, 'minute', '4', 'single_choice', 'لأنه مازال نصًا بديلًا ومؤقتًا.', 'لأنه مازال نصًا بديلًا ومؤقتًا.', 1, 0, 0, 0, 0, 1, 'standard', NULL, 1, 1, NULL, '2018-09-04 14:11:00', '2018-09-04 14:11:00'),
	(4, 'ومن هنا وجب على المصمم أن يضع نصوصا مؤقتة على التصميم ليظهر للعميل الشكل كاملًا،دور', NULL, 'ومن هنا وجب على المصمم أن يضع نصوصا مؤقتة على التصميم ليظهر للعميل الشكل كاملًا،دور مولد النص العربى أن يوفر على المصمم عناء البحث عن نص بديل لا علاقة له بالموضوع الذى يتحدث عنه التصميم فيظهر بشكل لا يليق.', NULL, 'minute', '10', 'single_choice', 'ه بالموضوع الذى يتحدث عنه التصميم فيظهر بشكل لا يليق.', 'ن نص بديل لا علاقة له بالموضوع الذى يتحدث عنه التصميم فيظهر بشكل لا يليق.', 1, 0, 0, 0, 0, 1, 'standard', NULL, 1, 1, NULL, '2018-09-04 14:15:45', '2018-09-04 14:16:10');
...
INSERT INTO `lms_quizzes` (`id`, `title`, `slug`, `meta_keywords`, `meta_description`, `content`, `duration`, `duration_unit`, `preview`, `price`, `sale_price`, `preview_video`, `pagination_questions`, `review_questions`, `is_standlone`, `is_featured`, `in_home`, `total_degree`, `passing_grade`, `retake_count`, `show_check_answer`, `skip_question`, `show_hint`, `allow_comments`, `status`, `published_at`, `private`, `type`, `level`, `options`, `certificate_id`, `author_id`, `created_by`, `updated_by`, `deleted_at`, `created_at`, `updated_at`) VALUES
	(1, 'اختبار علي الوحده الاولى', 'quiz-1baldj88rc9psyr4', NULL, NULL, NULL, NULL, 'minute', 0, 0.00, 0.00, 'https://youtu.be/VdvEdMMtNMY', 0, 0, 0, 0, 0, NULL, '50', 1, 0, 0, 0, 0, 0, NULL, 0, 'standard', 'medium', NULL, NULL, NULL, 1, 1, NULL, '2018-09-04 12:44:41', '2018-09-04 12:44:41'),
	(2, 'اختبار على الادب', 'quiz-1lattu10rn24qyw', NULL, NULL, NULL, NULL, 'minute', 0, 0.00, 0.00, 'https://youtu.be/VdvEdMMtNMY', 0, 0, 0, 0, 0, '0', '50', 1, 0, 0, 0, 0, 0, NULL, 0, 'standard', 'medium', NULL, NULL, NULL, 1, 1, NULL, '2018-09-04 12:45:50', '2018-09-04 13:37:25'),
	(3, 'اختبار عام علي الوحدتين', 'quiz-1c8xe0hvqu09r1yg', NULL, NULL, '<p>هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة، لقد تم توليد هذا النص من مولد النص العربى، حيث يمكنك أن تولد مثل هذا النص أو العديد من النصوص الأخرى إضافة إلى زيادة عدد الحروف التى يولدها التطبيق.<br />\r\nإذا كنت تحتاج إلى عدد أكبر من الفقرات يتيح لك مولد النص العربى زيادة عدد الفقرات كما تريد، النص لن يبدو مقسما ولا يحوي أخطاء لغوية، مولد النص العربى مفيد لمصممي المواقع على وجه الخصوص، حيث يحتاج العميل فى كثير من الأحيان أن يطلع على صورة حقيقية لتصميم الموقع.</p>', '5', 'minute', 0, 8.00, 8.00, 'https://youtu.be/VdvEdMMtNMY', 0, 0, 1, 0, 0, '9', '50', 1, 0, 0, 1, 1, 1, NULL, 0, 'standard', 'medium', NULL, NULL, NULL, 1, 1, NULL, '2018-09-04 12:46:03', '2018-09-04 14:09:09'),
	(4, 'اختبار لغة عربية', '654654', NULL, NULL, '<p>هذا النص يمكن أن يتم تركيبه على أي تصميم دون مشكلة فلن يبدو وكأنه نص منسوخ، غير منظم، غير منسق، أو حتى غير مفهوم. لأنه مازال نصًا بديلًا ومؤقتًا.</p>', '1', 'hour', 1, 0.00, 7.00, NULL, 1, 1, 1, 0, 0, '13', '50', 1, 1, 1, 1, 1, 1, NULL, 0, 'standard', 'medium', NULL, NULL, NULL, 1, 1, NULL, '2018-09-04 13:39:22', '2018-09-04 14:11:41'),
	(5, 'اختبار تاريخ', '111sthb', NULL, NULL, '<p>ومن هنا وجب على المصمم أن يضع نصوصا مؤقتة على التصميم ليظهر للعميل الشكل كاملًا،دور مولد النص العربى أن يوفر على المصمم عناء البحث عن نص بديل لا علاقة له بالموضوع الذى يتحدث عنه التصميم فيظهر بشكل لا يليق.</p>', '4', 'minute', 0, 5.00, 5.00, 'https://youtu.be/VdvEdMMtNMY', 0, 0, 1, 0, 0, '13', '50', 1, 1, 0, 1, 0, 1, NULL, 0, 'standard', 'medium', NULL, NULL, NULL, 1, 1, NULL, '2018-09-04 14:13:02', '2018-09-04 14:13:04'),
	(6, 'اختبار رياضيات', '65365', NULL, NULL, '<p>ومن هنا وجب على المصمم أن يضع نصوصا مؤقتة على التصميم ليظهر للعميل الشكل كاملًا،دور مولد النص العربى أن يوفر على المصمم عناء البحث عن نص بديل لا علاقة له بالموضوع الذى يتحدث عنه التصميم فيظهر بشكل لا يليق.&nbsp;ومن هنا وجب على المصمم أن يضع نصوصا مؤقتة على التصميم ليظهر للعميل الشكل كاملًا،دور مولد النص العربى أن يوفر على المصمم عناء البحث عن نص بديل لا علاقة له بالموضوع الذى يتحدث عنه التصميم فيظهر بشكل لا يليق.</p>', '8', 'minute', 1, 21.00, 19.00, 'https://youtu.be/VdvEdMMtNMY', 0, 0, 1, 0, 0, '13', '50', 1, 0, 0, 1, 1, 1, NULL, 0, 'standard', 'medium', NULL, NULL, NULL, 1, 1, NULL, '2018-09-04 14:14:29', '2018-09-04 14:14:31'),
	(7, 'اختباار عاااام', '643132', NULL, NULL, '<p>ومن هنا وجب على المصمم أن يضع نصوصا مؤقتة على التصميم ليظهر للعميل الشكل كاملًا،دور مولد النص العربى أن يوفر على المصمم عناء البحث عن نص بديل لا علاقة له بالموضوع الذى يتحدث عنه التصميم فيظهر بشكل لا يليق.&nbsp;ومن هنا وجب على المصمم أن يضع نصوصا مؤقتة على التصميم ليظهر للعميل الشكل كاملًا،دور مولد النص العربى أن يوفر على المصمم عناء البحث عن نص بديل لا علاقة له بالموضوع الذى يتحدث عنه التصميم فيظهر بشكل لا يليق.</p>', NULL, 'minute', 1, 8.00, 6.00, NULL, 1, 1, 0, 0, 0, '23', '50', 1, 1, 1, 1, 1, 1, NULL, 0, 'standard', 'medium', NULL, NULL, NULL, 1, 1, NULL, '2018-09-04 14:18:17', '2018-09-04 14:18:19');
...
INSERT INTO `lms_sectionables` (`id`, `lms_sectionable_type`, `lms_sectionable_id`, `type`, `section_id`, `course_id`, `order`) VALUES
	(2, 'lesson', 3, 'lesson', 3, 0, 0),
	(3, 'lesson', 5, 'lesson', 4, 0, 0),
	(4, 'lesson', 2, 'lesson', 4, 0, 1),
	(6, 'lesson', 4, 'lesson', 3, 0, 1),
	(7, 'lesson', 2, 'lesson', 3, 0, 2),
	(8, 'quiz', 6, 'quiz', 3, 0, 3),
	(9, 'lesson', 1, 'lesson', 4, 0, 2),
	(10, 'lesson', 3, 'lesson', 4, 0, 3),
	(11, 'lesson', 6, 'lesson', 5, 0, 0);
...
-- Dumping data for table alrabeh.lms_testimonials: ~1 rows (approximately)
...
INSERT INTO `media` (`id`, `model_type`, `model_id`, `collection_name`, `name`, `file_name`, `mime_type`, `disk`, `size`, `manipulations`, `custom_properties`, `order_column`, `created_at`, `updated_at`) VALUES
	...
	(21, 'Modules\\Components\\LMS\\Models\\Testimonial', 1, 'lms-testimonial-thumbnail', 'about', 'about.jpg', 'image/jpeg', 'media', 192308, '[]', '{"root":"user_oeb0qA042O"}', 21, '2018-09-29 13:21:49', '2018-09-29 13:21:49');

		...
		@endphp
		 ...
		 @include('components.favourite_action', ['module' => 'quiz', 'module_hash_id' => $quiz->hashed_id])
						<div class="take-it">
	                        ...
	                        <a href="{{route('quizzes.quizPage', ['quiz_id' => $quiz->hashed_id])}}" class="btn btn-danger"> عرض الأسئلة</a>
	                        @endif
					...
					<div class="course-media">
						<img src="{{$quiz->thumbnail}}" alt="{{$quiz->title}}" style="max-width: 100%; height: 400px; vertical-align: middle;">
                     </div>
                     @endif
...
@include('components.subscribe_modal', ['modal_id' => 'subQuiz_'.$quiz->hashed_id,'subscriptionStatus' => $subscriptionStatus, 'planned' => $planned, 'module_data' => $quiz, 'module' => 'quiz', 'finalPrice' => $quizPrice])

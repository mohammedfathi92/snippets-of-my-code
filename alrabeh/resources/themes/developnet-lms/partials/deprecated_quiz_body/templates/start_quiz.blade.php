			...
			<input type="hidden" name="course_id" value="{{$course->hashed_id}}">
							<div class="start-quiz-group" id="start_quiz_form">
								...
								<div class="start-quiz-btns">
									...
									<a href="javascript:;" class="btn btn-success" data-quiz_duration={{$quiz->duration}} id="start_quiz_btn"  data-form_url="{{route('quizzes.enroll_quiz', ['quiz' => $quiz->hashed_id])}}">Start Quiz</a>
								</div>
							</div>
		</div>

...
@section('css')
    {!! Html::style('assets/modules/plugins/cropper/cropper.css') !!}
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <div class="tab-pane @if($active_tab=="profile") active @endif" id="profile">
                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="edit_profile">
                                    <div class="row">
                                        ...
                                        <div id="country-div" class="col-md-4">
                                            {!! ModulesForm::text('phone_country_code','User::attributes.user.phone_country_code',true,null,['id'=>'authy-countries']) !!}
                                ...
                                {{-- <div class="tab-pane" id="notification_preferences">
                                    @forelse(\ModulesNotification::getUserNotificationTemplates(user()) as $notifications_template)
                                        <div class="row">
                                            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                {!! ModulesForm::formButtons(trans('corals-admin::labels.auth.save',['title' => $title_singular]),[],['href'=>url('dashboard')]) !!}
                            </div>
                        </div>
                        {!! Form::close() !!}
                    </div>
...
@endsection
@section('js')
    {!! Html::script('assets/modules/plugins/cropper/cropper.js') !!}

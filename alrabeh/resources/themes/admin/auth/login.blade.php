...
@section('content')
    ...
    <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12">
                        <div class="checkbox icheck">
                            <label>
                                <input type="checkbox"
                                       name="remember" {{ old('remember') ? 'checked' : '' }} class="disable-icheck" /> @lang('corals-admin::labels.auth.remember_me')
                            </label>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-6 login-right">
            ...
            <div class="or-separator">@lang('corals-admin::labels.auth.or')</div>

<aside class="sidebar sidebar-offcanvas">
    ...
    <section class="widget widget-categories">
        <h3 class="widget-title">@lang('Packages-ecommerce-basic::labels.partial.categories')</h3>
        <ul>
    ...
    <section class="widget widget-tags">
        <h3 class="widget-title">@lang('Packages-ecommerce-basic::labels.partial.tag_cloud')</h3>

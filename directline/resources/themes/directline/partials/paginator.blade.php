        ...
        @if (!$paginator->onFirstPage())
            <div class="column text-left hidden-xs-down">
                <a class="btn btn-outline-secondary btn-sm" href="{{ $paginator->previousPageUrl() }}">
                    <i class="icon-arrow-left"></i>&nbsp; @lang('Packages-ecommerce-basic::labels.partial.previous')</a>
            </div>
        @endif
        <div class="column">
            <ul class="pages">
        ...
        @if ($paginator->hasMorePages())
            <div class="column text-right hidden-xs-down">
                <a class="btn btn-outline-secondary btn-sm" href="{{ $paginator->nextPageUrl() }}">
                    @lang('Packages-ecommerce-basic::labels.partial.next')&nbsp;<i class="icon-arrow-right"></i></a>
            </div>
        @endif
    </nav>
@endif

<form id="filterForm">
    ...
    <section class="widget widget-categories">
        <h3 class="widget-title">@lang('Packages-ecommerce-basic::labels.template.shop.shop_categories')</h3>
        <ul>
                        ...
                        <div class="">
                            <input class=""
                                   ...
                                   id="ex-check-{{ $category->id }}"
                                    {{ \Shop::checkActiveKey($category->id,'category')?'checked':'' }}>
                            <label class=""
    ...
    <!-- Widget Price Range-->
{{--     <section class="widget widget-categories">
        <h3 class="widget-title">@lang('Packages-ecommerce-basic::labels.template.shop.price_range')</h3>
    ...
    @if(!($brands = \Shop::getActiveBrands())->isEmpty())
        <section class="widget">
            <h3 class="widget-title">@lang('Packages-ecommerce-basic::labels.template.shop.filter_brand')</h3>
    ...
    <section class="widget">
        <div class="column">
            <button class="btn btn-outline-primary btn-block btn-sm"
                    type="submit">@lang('Packages-ecommerce-basic::labels.template.shop.filter')</button>
        </div>
    </section>
</form>

...
if (\Schema::hasTable('posts')
    && class_exists(\Packages\Modules\CMS\Models\Page::class)
    && class_exists(\Packages\Modules\CMS\Models\Post::class)
) {
    \Packages\Modules\CMS\Models\Page::updateOrCreate(['slug' => 'home', 'type' => 'page',],
        array(
            'title' => 'Home',
            'slug' => 'home',
            'meta_keywords' => 'home',
    ...
    \Packages\Modules\CMS\Models\Page::updateOrCreate(['slug' => 'about-us', 'type' => 'page'],
        array(
            'title' => 'About Us',
            'slug' => 'about-us',
...
<div class="container padding-bottom-2x mb-2">
    <div class="row align-items-center padding-bottom-2x">
        ...
        <div class="col-md-7 text-md-left text-center">
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam id purus at risus pellentesque faucibus
                ...
                class="text-medium text-decoration-none" href="https://codecanyon.net/user/Packages-io/portfolio" target="_blank">View Products&nbsp;<i
    ...
    \Packages\Modules\CMS\Models\Page::updateOrCreate(['slug' => 'blog', 'type' => 'page'],
        array(
            'title' => 'Blog',
            'slug' => 'blog',
            'meta_keywords' => 'Blog',
    ...
    \Packages\Modules\CMS\Models\Page::updateOrCreate(['slug' => 'pricing', 'type' => 'page'],
        array(
            'title' => 'Pricing',
    ...
    \Packages\Modules\CMS\Models\Page::updateOrCreate(['slug' => 'contact-us', 'type' => 'page'],
        array(
            'title' => 'Contact Us',
            'slug' => 'contact-us',
            ...
            <div class="col">
                <div class="text-center">
                    ...
                    <p>You can contact us with anything related to developnet. <br/> We\'ll get in touch with you as soon as
                        possible.</p>
                </div>
            </div>
        </div>',
    ...
    $posts[] = \Packages\Modules\CMS\Models\Post::updateOrCreate(['slug' => 'subscription-commerce-trends-for-2018', 'type' => 'post'],
        array(
...
<p>&nbsp;</p>',
    ...
    $posts[] = \Packages\Modules\CMS\Models\Post::updateOrCreate(['slug' => 'using-machine-learning-to-optimize-subscription-billing', 'type' => 'post'],
        array(
...
<p>A typical machine learning project involves gathering data, training a statistical model on that data, and then evaluating the performance of the model when presented with new data. A model is only as good as the data it&rsquo;s trained on, and here we had a huge advantage.</p>',
    ...
    $posts[] = \Packages\Modules\CMS\Models\Post::updateOrCreate(['slug' => 'why-you-need-a-blog-subscription-landing-page', 'type' => 'post'],
        array(
...
if (\Schema::hasTable('categories') && class_exists(\Packages\Modules\CMS\Models\Category::class)) {
    $categories[] = \Packages\Modules\CMS\Models\Category::updateOrCreate([
        'name' => 'Computers',
        'slug' => 'computers',
    ]);
    $categories[] = \Packages\Modules\CMS\Models\Category::updateOrCreate([
...
$posts_media = [
    0 => array(
        'id' => 4,
        'model_type' => 'Packages\\Modules\\CMS\\Models\\Post',
...
if (class_exists(\Packages\Menu\Models\Menu::class) && \Schema::hasTable('posts')) {
    // seed root menus
    $topMenu = Packages\Menu\Models\Menu::updateOrCreate(['key' => 'frontend_top'], [
        'parent_id' => 0,
        'url' => null,
        'name' => 'Frontend Top',
    ...
    // seed children menu
    Packages\Menu\Models\Menu::updateOrCreate(['key' => 'home'], [
        'parent_id' => $topMenuId,
        'url' => '/',
        'active_menu_url' => '/',
        'name' => 'Home',
    ...
    Packages\Menu\Models\Menu::updateOrCreate(['parent_id' => $topMenuId, 'key' => 'shop'], [
        'url' => 'shop',
    ...
    Packages\Menu\Models\Menu::updateOrCreate([
        'parent_id' => $topMenuId,
        'key' => null,
        'url' => 'about-us',
    ...
    $footerMenu = Packages\Menu\Models\Menu::updateOrCreate(['key' => 'frontend_footer'], [
        'parent_id' => 0,
        'url' => null,
...
// seed children menu
    Packages\Menu\Models\Menu::updateOrCreate(['key' => 'footer_home'], [
...
if (class_exists(\Packages\Modules\Ecommerce\Models\Product::class) && \Schema::hasTable('ecommerce_products')) {
    ///////////////////////// Shippings
    $shippings = array(
        array(
            'priority' => 1,
    ...
    foreach ($shippings as $shipping) {
        \Packages\Modules\Ecommerce\Models\Shipping::updateOrCreate([
    ...
    foreach ($coupons as $coupon) {
        \Packages\Modules\Ecommerce\Models\Coupon::updateOrCreate(['code' => $coupon['code']], $coupon);
    }
    ...
    foreach ($ecommerceSettings as $setting) {
        \Packages\Settings\Models\Setting::updateOrCreate(['code' => $setting['code']], $setting);
    }

    ///////////////////////// Categories
    $mobilesCat = \Packages\Modules\Ecommerce\Models\Category::updateOrCreate(['name' => 'Mobiles', 'slug' => 'mobiles'], [
        'is_featured' => 1,
    ]);

    $tabletsCat = \Packages\Modules\Ecommerce\Models\Category::updateOrCreate(['name' => 'Tablets', 'slug' => 'tablets'], [
        'is_featured' => 1,
    ]);

    $accessoriesCat = \Packages\Modules\Ecommerce\Models\Category::updateOrCreate(['name' => 'Accessories', 'slug' => 'accessories'], [
        'is_featured' => 1,
    ]);

    $headphones = \Packages\Modules\Ecommerce\Models\Category::updateOrCreate(['name' => 'Headphones', 'slug' => 'headphones'], [
        'is_featured' => 0,
        'parent_id' => $accessoriesCat->id
    ]);

    $cases = \Packages\Modules\Ecommerce\Models\Category::updateOrCreate(['name' => 'Cases', 'slug' => 'cases'], [
        'is_featured' => 0,
        'parent_id' => $accessoriesCat->id
    ]);

    $chargers = \Packages\Modules\Ecommerce\Models\Category::updateOrCreate(['name' => 'Chargers', 'slug' => 'chargers'], [
        'is_featured' => 0,
        'parent_id' => $accessoriesCat->id
    ]);

    $memCards = \Packages\Modules\Ecommerce\Models\Category::updateOrCreate(['name' => 'Memory Cards', 'slug' => 'mem-cards'], [
        'is_featured' => 0,
        'parent_id' => $accessoriesCat->id
    ]);

    $screenProtector = \Packages\Modules\Ecommerce\Models\Category::updateOrCreate(['name' => 'Screen Protector', 'slug' => 'screen-protector'], [
        'is_featured' => 0,
        'parent_id' => $accessoriesCat->id
    ]);
    ...
    $catsMedia = array(
        array(
            ...
            'model_type' => 'Packages\\Modules\\Ecommerce\\Models\\Category',
    ...
    foreach ($tags as $tag) {
        $tagsObjects->push(\Packages\Modules\Ecommerce\Models\Tag::updateOrCreate(['slug' => $tag['slug']], $tag));
    }
    ///////////////////////// Brands

    $samsungBrand = \Packages\Modules\Ecommerce\Models\Brand::updateOrCreate(['name' => 'Samsung', 'slug' => 'samsung-mobile'], [
        'is_featured' => 1,
    ]);

    $appleBrand = \Packages\Modules\Ecommerce\Models\Brand::updateOrCreate(['name' => 'Apple', 'slug' => 'apple-mobile'], [
        'is_featured' => 1,
    ]);

    $huaweiBrand = \Packages\Modules\Ecommerce\Models\Brand::updateOrCreate(['name' => 'Huawei', 'slug' => 'huawei-mobile'], [
        'is_featured' => 1,
    ]);

    $htcBrand = \Packages\Modules\Ecommerce\Models\Brand::updateOrCreate(['name' => 'HTC', 'slug' => 'htc-mobile'], [
        'is_featured' => 1,
    ]);

    $lgBrand = \Packages\Modules\Ecommerce\Models\Brand::updateOrCreate(['name' => 'LG', 'slug' => 'lg-mobile'], [
        'is_featured' => 1,
    ]);
    ...
    $brandsMedia = array(
        array(
            'model_id' => $lgBrand->id,
            'model_type' => 'Packages\\Modules\\Ecommerce\\Models\\Brand',
    ...
    ///////////////////////// Attributes
    $memoryAttr = \Packages\Modules\Ecommerce\Models\Attribute::updateOrCreate(['type' => 'select', 'label' => 'Memory'], [
        'display_order' => 0,
        'use_as_filter' => 1,
        'required' => 1,
    ]);

    $storageAttr = \Packages\Modules\Ecommerce\Models\Attribute::updateOrCreate(['type' => 'select', 'label' => 'Storage'], [
        'display_order' => 1,
        'use_as_filter' => 1,
        'required' => 1,
    ]);

    $colorAttr = \Packages\Modules\Ecommerce\Models\Attribute::updateOrCreate(['type' => 'select', 'label' => 'Color'], [
        'display_order' => 2,
        'use_as_filter' => 1,
        'required' => 1,
    ]);

    $wirelessAttr = \Packages\Modules\Ecommerce\Models\Attribute::updateOrCreate(['type' => 'multi_values', 'label' => 'Wireless Technology'], [
        'display_order' => 3,
        'use_as_filter' => 0,
        'required' => 1,
    ]);
    ...
    foreach ($attrOptions as $option) {
        try {
            $attrOptionsObjects->push(\Packages\Modules\Ecommerce\Models\AttributeOption::updateOrCreate([
...
//    $samsungCat = \Packages\Modules\Ecommerce\Models\Category::updateOrCreate(['name' => 'Samsung', 'slug' => 'samsung'], [
//        'parent_id' => $mobileCat->id,
//        'is_featured' => 1,
//    ]);
//
//    $appleCat = \Packages\Modules\Ecommerce\Models\Category::updateOrCreate(['name' => 'Apple', 'slug' => 'apple'], [
//        'parent_id' => $mobileCat->id,
//        'is_featured' => 1,
//    ]);
//
//    $huaweiCat = \Packages\Modules\Ecommerce\Models\Category::updateOrCreate(['name' => 'Huawei', 'slug' => 'huawei'], [
//        'parent_id' => $mobileCat->id,
//        'is_featured' => 1,
//    ]);
//    $ecommerceMedia = [
...
//    );
//
//    $s9 = \Packages\Modules\Ecommerce\Models\Product::updateOrCreate(['name' => $s9['name']], $s9);
//
//    \Packages\Modules\Ecommerce\Models\SKU::updateOrCreate(['product_id' => $s9->id], [
//        'regular_price' => 799,
//        'code' => 'SG-S9',
...
//    );
//
//    $note8 = \Packages\Modules\Ecommerce\Models\Product::updateOrCreate(['name' => $note8['name']], $note8);
//    \Packages\Modules\Ecommerce\Models\SKU::updateOrCreate(['product_id' => $note8->id], [
//        'regular_price' => 949,
//        'code' => 'SN-8',
//        'inventory' => 'infinite', 'status' => 'active'
//    ]);
...
//        'is_featured' => 1,
//    );
//    $mate10 = \Packages\Modules\Ecommerce\Models\Product::updateOrCreate(['name' => $mate10['name']], $mate10);
//    \Packages\Modules\Ecommerce\Models\SKU::updateOrCreate(['product_id' => $mate10->id], [
//        'regular_price' => 755,
//        'code' => 'HM-10',
//        'inventory' => 'infinite', 'status' => 'active'
//    ]);
...
//    );
//
//    $iphone8 = \Packages\Modules\Ecommerce\Models\Product::updateOrCreate(['name' => $iphone8['name']], $iphone8);
//    \Packages\Modules\Ecommerce\Models\SKU::updateOrCreate(['product_id' => $iphone8->id], [
//        'regular_price' => 999,
//        'code' => 'Ai-8',
//        'inventory' => 'infinite', 'status' => 'active'
//    ]);
...
//    );
//
//    $iphone7 = \Packages\Modules\Ecommerce\Models\Product::updateOrCreate(['name' => $iphone7['name']], $iphone7);
//    \Packages\Modules\Ecommerce\Models\SKU::updateOrCreate(['product_id' => $iphone7->id], [
//        'regular_price' => 785,
//        'code' => 'Ai-7',
//        'inventory' => 'infinite', 'status' => 'active'
//    ]);
...
//        array(
//            'model_id' => $s9->id,
//            'model_type' => 'Packages\\Modules\\Ecommerce\\Models\\Product',
...
if (class_exists(\Packages\Modules\Slider\Models\Slider::class) && \Schema::hasTable('sliders')) {
    $slider = \Packages\Modules\Slider\Models\Slider::updateOrCreate(['key' => 'e-commerce-home-page-slider'],
        array(
    ...
    foreach ($slides as $slide) {
        \Packages\Modules\Slider\Models\Slide::updateOrCreate(
...
/**
 * random orders
 * $skus = \Packages\Modules\Ecommerce\Models\SKU::get();
 ...
 *
 *
 *  $orders = \Packages\Modules\Ecommerce\Models\Order::get();
 *
 * foreach ($orders as $order) {
 * $invoice = \Packages\Modules\Payment\Models\Invoice::create([
 * 'code' => str_random(6),
 ...
 *
 *
 *  $users = \Packages\User\Models\User::whereHas('roles', function ($role) {
 ...
 * 'reviewrateable_id' => $g,
 * 'reviewrateable_type' => \Packages\Modules\Ecommerce\Models\Product::class,
 * 'author_id' => $user->id,
 * 'author_type' => Packages\User\Models\User::class
 * ]);
 * }
 * }
 * }

            ...
            <div class="col-xl-9 col-lg-8 order-lg-2">
                ...
                <div class="shop-toolbar padding-bottom-1x mb-2">
                    <div class="column">
                        <div class="shop-sorting">
                            <label for="sorting">@lang('Packages-ecommerce-basic::labels.template.shop.sort')</label>

                            <select class="form-control" id="shop_sort">
                                <option disabled="disabled"
                                        selected>@lang('Packages-ecommerce-basic::labels.template.shop.select_option')</option>
                            ...
                            <span class="text-muted">@lang('Packages-ecommerce-basic::labels.template.shop.show')
                                &nbsp;</span>
                            <span>{{trans('Packages-ecommerce-basic::labels.template.shop.page',['current'=>$products->currentPage(),'total' => $products->lastPage()])}}</span>
                        </div>
                    </div>
                    <div class="column">
                        <div class="shop-view">
                ...
                <div id="shop-items">
                    <div class="{{ $layout == 'grid'?'isotope-grid':'' }} cols-3 mb-2">
                        ...
                        @empty
                            <h4>@lang('Packages-ecommerce-basic::labels.template.shop.sorry_no_result')</h4>
                        @endforelse
                    </div>

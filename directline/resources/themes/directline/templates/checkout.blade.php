        ...
        <div id="checkoutWizard">
            <ul>
                <li><a href="#cart-details" data-content-url="{{url('checkout/step/cart-details')}}">
                        @lang('Packages-ecommerce-basic::labels.template.checkout.detail')<br/>
                        <small></small>
                    </a></li>

                <li><a href="#billing-shipping-address"
                       data-content-url="{{url('checkout/step/billing-shipping-address')}}">
                        @lang('Packages-ecommerce-basic::labels.template.checkout.address')<br/>
                        <small></small>
                    </a></li>
                @if($enable_shipping)
                    <li><a href="#shipping-method"
                           data-content-url="{{url('checkout/step/shipping-method')}}">
                            @lang('Packages-ecommerce-basic::labels.template.checkout.select_shipping')<br/>
                            <small></small>
                        </a></li>
                @endif
                <li><a href="#select-payment" data-content-url="{{url('checkout/step/select-payment')}}">
                        @lang('Packages-ecommerce-basic::labels.template.checkout.select_payment')<br/>
                        <small></small>
                    </a></li>
                <li><a href="#order-review" data-content-url="{{url('checkout/step/order-review')}}">
                        @lang('Packages-ecommerce-basic::labels.template.checkout.order_review')<br/>
                        <small></small>
                    </a></li>
            </ul>

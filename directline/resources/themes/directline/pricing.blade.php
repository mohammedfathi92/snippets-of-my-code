                        ...
                        @if(user() && user()->subscribed(null, $plan->id))
                            <a href="#"
                               class="btn btn-rounded {{ $plan->recommended?'btn-white-border':'btn-dark-border' }}">
                                @lang('Packages-ecommerce-basic::labels.pricing.current_package')
                            </a>
                            <br/>
                        ...
                        @else
                            <a class="btn btn-rounded {{ $plan->recommended?'btn-white-border':'btn-dark-border' }}"
                               href="{{ url('subscriptions/checkout/'.$plan->hashed_id) }}">
                                @lang('Packages-ecommerce-basic::labels.pricing.subscribe_now')
                            </a>
                        @endif
                    </div>
                </div>
...
@else
    <p class="text-center text-danger"><strong>@lang('Packages-ecommerce-basic::labels.pricing.product_cannot_found')</strong></p>
@endisset
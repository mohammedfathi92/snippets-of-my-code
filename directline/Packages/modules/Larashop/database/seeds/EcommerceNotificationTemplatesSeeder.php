...
use Packages\User\Communication\Models\NotificationTemplate;
use Illuminate\Database\Seeder;

class LarashopNotificationTemplatesSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        NotificationTemplate::updateOrCreate(['name' => 'notifications.e_commerce.order.received'], [
            'friendly_name' => 'Larashop Order Received',

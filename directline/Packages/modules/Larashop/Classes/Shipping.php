...
use Packages\Modules\Larashop\Models\Shipping as ShippingModel;
use Packages\Modules\Larashop\Traits\ShippingTrait;
...
class Shipping
{
    ...
    public function getAvailableShippingMethods($shipping_address, $cart, $order_total)
    {
        ...
        foreach ($shipping_roles as $shipping_role) {
            try {
                ...
                $shipping_method = \App::make('Packages\\Modules\\Larashop\\Classes\\Shippings\\' . $shipping_role->shipping_method);
    ...
    public function track($order)
    {
        ...
        $shipping_method = \App::make('Packages\\Modules\\Larashop\\Classes\\Shippings\\' . $provider);
    ...
    {
        list($shipping_method, $shipping_object) = explode('|', $selected_shipping);
        $shipping_method = \App::make('Packages\\Modules\\Larashop\\Classes\\Shippings\\' . $shipping_method);
        $shipping_method->initialize();

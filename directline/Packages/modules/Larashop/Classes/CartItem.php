...
use Packages\Modules\Larashop\Traits\CartOptionsMagicMethodsTrait;
...
class CartItem
{
    ...
    public function setModel($itemModel, $relations = [])
    {
        if (!class_exists($itemModel)) {
            throw new ModelNotFound(trans('Larashop::exception.cart.not_find_relation'));
        }
    ...
    public function getModel()
    {
        ...
        if (empty($itemModel)) {
            throw new ModelNotFound(trans('Larashop::exception.cart.not_find model',['arg' => $this->id]));
        }

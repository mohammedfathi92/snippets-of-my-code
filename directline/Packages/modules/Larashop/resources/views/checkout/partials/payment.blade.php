<div class="row">
    <div class="col-md-8 col-md-offset-2 offset-md-2">
        ...
        @if($gateway)
            <h4>@lang('Larashop::labels.checkout.enter_payment')</h4>
            <hr>
        ...
        @else
            ...
            <div class="">
                ...
                <h4>@lang('Larashop::labels.checkout.select_payment')</h4>
                <hr>
                {!! PackagesForm::radio('select_gateway','',true,  $available_gateways ) !!}

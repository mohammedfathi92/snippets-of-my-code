    ...
    <div class="downloads-section {{ $class = str_random().'_downloads' }}">
        ...
        <div class="table-responsive">
            <table id="downloads-table" width="100%" class="table table-striped">
                <thead>
                <tr>
                    <th width="30%">@lang('Larashop::labels.product.file')</th>
                    <th width="70%">@lang('Larashop::labels.product.description')</th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
        ...
        <span class="help-block">@lang('Larashop::labels.product.add_download')</span>
    </div>
</div>

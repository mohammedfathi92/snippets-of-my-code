...
@section('content')
    <div class="row">
                                ...
                                <div class="col-md-6 text-center">
                                    ...
                                    @else
                                        <button type="button"
                                            ...
                                            <b>@lang('Larashop::labels.shop.out_stock')</b>
                                        </button>
        ...
        <div class="row m-t-20">
            <div class="col-md-4">
                {!! PackagesForm::number('quantity','Larashop::attributes.shop.quantity', false, 1, ['min' => 1]) !!}
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
            ...
            <div class="col-md-12">
                @if($product->external_url)
                    <a href="{{ $product->external_url }}" target="_blank" class="btn btn-default btn-block m-t-10 "
                       title="Buy Product">
                        <i class="fa fa-fw fa-cart-plus" aria-hidden="true"></i> @lang('Larashop::labels.shop.buy')
                    </a>
                ...
                @else
                    {!! PackagesForm::formButtons('Larashop::labels.shop.add_cart',['class'=>'btn btn-default btn-block m-t-10 add-to-cart'], ['show_cancel'=>false]) !!}
                @endif
            </div>
        </div>
    ...
    @if($product->getMedia('ecommerce-product-gallery')->count())
        <div class="col-md-4">
            @component('components.box')
                @include('Larashop::products.gallery',['product'=>$product,'editable'=>false])
            @endcomponent
        </div>
    @endif
@endsection

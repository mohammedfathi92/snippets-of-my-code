    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%"
                ...
                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                        <td width="10%" align="left" bgcolor="#eeeeee"
                            ...
                            @lang('Larashop::labels.mail.amount')
                        </td>
                        <td width="10%" align="left" bgcolor="#eeeeee"
                            style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;">
                            @lang('Larashop::labels.mail.qt')
                        </td>
                        <td width="50%" align="left" bgcolor="#eeeeee"
                            style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;">
                            @lang('Larashop::labels.mail.description')
                        </td>

                        <td width="15%" align="left" bgcolor="#eeeeee"
                            style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;">
                            @lang('Larashop::labels.mail.sku')
                        </td>

                        <td width="15%" align="left" bgcolor="#eeeeee"
                            style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;">
                            @lang('Larashop::labels.mail.type')
                        </td>
                    </tr>
                ...
                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                    <tr>
                        <td width="75%" align="left"
                            ...
                            @lang('Larashop::labels.mail.total')
                        </td>
            ...
            <tr>
                <td align="left"
                    ...
                    <h5 style="font-size: 15px; font-weight: 800; line-height: 36px; color: #333333; margin: 0;">
                        @lang('Larashop::labels.mail.download')
                    </h5>
                </td>
            </tr>
            <tr>
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                        <tr>
                            <td width="30%" align="left" bgcolor="#eeeeee"
                                style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 800; line-height: 24px; padding: 10px;">
                                @lang('Larashop::labels.mail.file')
                            </td>
        ...
        @if(count($order->posts))
            <tr>
                <td align="left"
                    style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; padding-top: 25px;">
                    <h5 style="font-size: 15px; font-weight: 800; line-height: 36px; color: #333333; margin: 0;">
                        @lang('Larashop::labels.mail.premium_content')
                    </h5>
                </td>
            </tr>
            <tr>
                <td>
                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                        @foreach($order->posts as $post)
                            <tr>
                                <td>
                                    {!! PackagesForm::link(url($post->slug),'<i class="fa fa-magic"></i>  '.$post->title,['class'=>'','target'=>'_blank']) !!}
                                </td>
                            </tr>
                        @endforeach
                    </table>
        ...
        <tr>
            <td align="left"
                style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; padding-top: 25px;">
                <h5 style="font-size: 15px; font-weight: 800; line-height: 36px; color: #333333; margin: 0;">
                    @lang('Larashop::labels.mail.bill_address')
                </h5>
            </td>
        </tr>
        <tr>
                    ...
                    @isset($order->billing['billing_address'])
                        <tr>
                            <td width="30%" align="left"
                                ...
                                @lang('Larashop::labels.mail.address_one')
                            </td>
                        ...
                        <tr>
                            <td width="30%" align="left"
                                style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 600; line-height: 24px; padding: 10px;">
                                @lang('Larashop::labels.mail.address_two')
                            </td>
                        ...
                        <tr>
                            <td width="30%" align="left"
                                style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 600; line-height: 24px; padding: 10px;">
                                @lang('Larashop::labels.mail.city')
                            </td>
                        ...
                        <tr>
                            <td width="30%" align="left"
                                style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 600; line-height: 24px; padding: 10px;">
                                @lang('Larashop::labels.mail.state')
                            </td>
                        ...
                        <tr>
                            <td width="30%" align="left"
                                style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 14px; font-weight: 600; line-height: 24px; padding: 10px;">
                                @lang('Larashop::labels.mail.country')
                            </td>
        ...
        @if($order->shipping)
            <tr>
                <td align="left"
                    style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; padding-top: 25px;">
                    <h5 style="font-size: 15px; font-weight: 800; line-height: 36px; color: #333333; margin: 0;">
                        @lang('Larashop::labels.mail.shipping_details')
                    </h5>
                </td>
            </tr>
            <tr>
            ...
            @if(isset($order->shipping['tracking_number']) && !empty($order->shipping['tracking_number']))
                <tr>
                    <td align="left"
                        style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; padding-top: 25px;">
                        <h5 style="font-size: 15px; font-weight: 800; line-height: 36px; color: #333333; margin: 0;">
                            @lang('Larashop::labels.mail.tracking_num')
                        </h5>
                    </td>
                </tr>
                <tr>
            ...
            @if(isset($order->shipping['label_url']) && !empty($order->shipping['label_url']))
                <tr>
                    <td align="left"
                        style="font-family: Open Sans, Helvetica, Arial, sans-serif; font-size: 16px; font-weight: 400; line-height: 24px; padding-top: 25px;">
                        <h5 style="font-size: 15px; font-weight: 800; line-height: 36px; color: #333333; margin: 0;">
                            @lang('Larashop::labels.mail.tracking_label')
                        </h5>
                    </td>
                </tr>
                <tr>
                    <td align="left"
                        ...
                        <a target="_blank"
                           href="{{ $order->shipping['label_url'] }}">
                            @lang('Larashop::labels.mail.click_here')
                        </a>
                    </td>
                </tr>
            @endif

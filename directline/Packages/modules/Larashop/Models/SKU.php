        ...
        if (!$available) {
            ...
            if ($throw_error) {
                ...
                if ($available_quantity) {
                    throw new \Exception(trans('Larashop::exception.sku.item_has_only_quantity', ['quantity' => $available_quantity]));

                } else {
                    throw new \Exception(trans('Larashop::exception.sku.item_current_out'));

...
class CheckoutRequest extends BaseRequest
{
    ...
    public function authorize()
    {
        ...
        return user()->hasPermissionTo('Larashop::cart.access');
    }
    ...
    public function rules()
    {
        ...
        if ($step == "billing-shipping-address") {
            $rules = array_merge($rules, [
                ...
                'billing_address.zip' => 'required|digits_between:4,7',
            ]);
            if (\ShoppingCart::getAttribute('enable_shipping')) {
                $rules = array_merge($rules, [
                    ...
                    'shipping_address.zip' => 'required|digits_between:4,7',
                ]);
            }
    ...
    {
        return [
            'checkoutToken.required' => trans('Larashop::labels.checkout.please_enter_payment'),
        ];
    }
}

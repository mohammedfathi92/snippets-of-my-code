...
use Packages\Modules\Payment\DataTables\TaxesDataTable;
use Packages\Modules\Payment\Common\Http\Requests\TaxRequest;
use Packages\Modules\Payment\Models\Tax;
...
class TaxesController extends BaseController
{
    ...
    {
        $this->setViewSharedData(['title_singular' => trans('Packages::labels.show_title', ['title' => $tax->name])]);
    ...
    {
        $this->setViewSharedData(['title_singular' => trans('Packages::labels.update_title', ['title' => $tax->name])]);

...
namespace Packages\Modules\Payment\Common;
...
class Helper
{
    ...
    public static function getGatewayShortName($className)
    {
        ...
        if (0 === strpos($className, 'Packages\Modules\Payment\\')) {
     ...
     * Non-namespaced classes are expected to be in the \Packages\Modules\Payment namespace, e.g.:
     *
     *      \Custom\Gateway     => \Custom\Gateway
     *      \Custom_Gateway     => \Custom_Gateway
     *      Stripe              => \Packages\Modules\Payment\Stripe\Gateway
     *      PayPal\Express      => \Packages\Modules\Payment\PayPal\ExpressGateway
     *      PayPal_Express      => \Packages\Modules\Payment\PayPal\ExpressGateway
     *
    ...
    public static function getGatewayClassName($shortName)
    {
        ...
        return '\\Packages\Modules\Payment\\' . $shortName . 'Gateway';
    }

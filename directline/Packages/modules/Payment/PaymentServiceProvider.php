...
use Packages\Modules\Payment\Providers\PaymentObserverServiceProvider;
use Packages\Modules\Payment\Providers\PaymentRouteServiceProvider;
use Packages\Settings\Models\Module;
use Illuminate\Foundation\AliasLoader;
use Illuminate\Support\ServiceProvider;
use Torann\Currency\CurrencyServiceProvider;
use Packages\Modules\Payment\Common\Hooks\Payment as PaymentHooks;
...
class PaymentServiceProvider extends ServiceProvider
{
                ...
                foreach ($configFiles as $file) {
                    ...
                    if ($events = config($configKey . '.events')) {
                        foreach ($events as $eventName => $jobClass) {
                            \Packages\Modules\Payment\Facades\Webhooks::registerEvent("{$gateway}.{$eventName}", $jobClass);
                        }
                    }
                }
            }
    ...
    public function register()
    {
        ...
        $this->app->booting(function () {
            ...
            $loader->alias('Payments', \Packages\Modules\Payment\Facades\Payments::class);
    ...
    {
        \Shortcode::addWidget('revenue', \Packages\Modules\Payment\Widgets\RevenueWidget::class);
        \Shortcode::addWidget('monthly_revenue', \Packages\Modules\Payment\Widgets\MonthlyRevenueWidget::class);
    }

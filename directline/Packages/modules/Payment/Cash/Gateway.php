...
class Gateway extends AbstractGateway
{
    ...
    {
        return $this->createRequest('\Packages\Modules\Payment\Cash\Message\CreateCustomerRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('\Packages\Modules\Payment\Cash\Message\UpdateCustomerRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('\Packages\Modules\Payment\Cash\Message\CreateSubscriptionRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('\Packages\Modules\Payment\Cash\Message\CancelSubscriptionRequest', $parameters);
    }


    public function prepareCustomerParameters(User $user, $extra = [])
    {
        $parameters['customerData'] = ['description' => $user->name, 'email' => $user->email, 'name' => $user->name, 'MerchantCustomerId' => $user->id];

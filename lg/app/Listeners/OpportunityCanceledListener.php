...
class OpportunityCanceledListener
{
    /**
     ...
     * @return void
     */
    public function handle(OpportunityCanceled $event)
    {
        $user=Auth::user();
        ...
        $notification->message="notifications.info_opportunity_lost";
        ...
        // send email to user after his opportunity closed
            ...
            Mail::send("emails.user_opportunity_canceled",["data"=>$event->opportunity,"language"=>$language],function ($m) use ($event,$language){

        ...
        <div class="panel">
            <div class="panel">
                <ol class="breadcrumb">
                    ...
                    <li class="active">{{trans("users.link_account")}}</li>
                </ol>
            </div>
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-2 {{$errors->has('email')?'has-error':''}}"
                            ...
                            <div class="form-group">
                               <div class="col-md-2">
                                ...
                                <a href="#" data-toggle="collapse" data-target="#changePassword">{{trans("users.link_change_password")}}</a>
                                <div class="col-md-10 collapse {{$errors->has('password')?'in':''}}" id="changePassword">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-10">
                                   <p>{{trans_choice("users.permissions",$data->permission)}}</p>
                                </div>
                            </div>
                            ...
                            <div class="form-group {{$errors->has('job')?'has-error':''}}">
                                <label class="control-label col-md-2"
                                       for="job">{{trans('users.label_job')}}</label>
                                <div class="col-md-10">
                                    {!! Form::text("job",old('job',$data->job),['class'=>'form-control','id'=>'job']) !!}
                                    @if ($errors->has('job'))
                                        <span class="help-block">

                        ...
                        <table style="{{ $style['email-body_inner'] }}" align="center" width="570" cellpadding="0"
                            ...
                            <tr>
                                <td style="{{ $fontFamily }} {{ $style['email-body_cell'] }}">
                                    <!-- Greeting -->
                                    <h1 style="{{ $style['header-1'] }}"> {{trans("users.email_account_created_heading")}} </h1>

                                    <!-- Intro -->
                                    <p style="{{ $style['paragraph'] }}">
                                        {!! trans("users.email_account_created_message",['name'=>$user->name]) !!}
                                    </p>
                                    <!-- Action Button -->
                                    ...
                                    <table style="{{ $style['body_action'] }}" align="center" width="100%"
                                        ...
                                        <tr>
                                            <td align="center">
                                                <a href="http://lgecm.com"
                                                   style="{{ $fontFamily }} {{ $style['button'] }} {{ $style['button--green'] }}"
                                                   class="button"
                                                   target="_blank">
                                                    {{trans("users.email_btn_go_login")}}
                                                </a>
                                            </td>
                                        </tr>
                                    </table>
                                ...
                                <td style="{{ $fontFamily }} {{ $style['email-footer_cell'] }}">
                                    <p style="{{ $style['paragraph-sub'] }}">
                                        ...
                                        <a style="{{ $style['anchor'] }}" href="{{ url('/') }}"
                                           target="_blank">{{trans("main.app_title")}}</a>.
                                        All rights reserved.
                                    </p>
                                </td>
                            </tr>

        ...
        <div class="panel">
            <div class="panel">
                <ol class="breadcrumb">
                    ...
                    <li class="active">({{trans("users.title_create")}}</li>
                </ol>
            </div>
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="example-wrap">
                            ...
                            <div class="form-group required {{$errors->has('permission')?'has-error':''}}">
                                ...
                                <div class="col-md-10">
                                    <select name="permission" id="permission" class="form-control select2">
                                        <option value="1" {{old("permission")==1?"selected":""}}>{{trans("users.option_supervisor")}}</option>
                                        <option value="2" {{old("permission",2)==2?"selected":""}}>{{trans("users.option_partner")}}</option>
                                    </select>
                                    @if ($errors->has('about'))
                                        <span class="help-block">
                            ...
                            <div class="form-group {{$errors->has('annual_sales')?'has-error':''}}">
                                ...
                                <div class="col-md-10">
                                    {!! Form::text("annual_sales",old('annual_sales'),['class'=>'form-control','id'=>'annual_sales']) !!}
                            ...
                            <div class="form-group {{$errors->has('phone')?'has-error':''}}">
                                ...
                                <div class="col-md-10">
                                    {!! Form::tel("phone",old('phone'),['class'=>'form-control','id'=>'phone']) !!}
                                    @if ($errors->has('phone'))
                                        <span class="help-block">
                            ...
                            <div class="form-group {{$errors->has('about')?'has-error':''}}">
                                ...
                                <div class="col-md-10">
                                    {!! Form::textarea("about",old('about'),['class'=>'form-control','id'=>'about']) !!}
                                    @if ($errors->has('about'))
                                        <span class="help-block">

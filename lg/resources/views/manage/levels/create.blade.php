        ...
        <div class="panel">
            <div class="panel">
                <ol class="breadcrumb">
                    ...
                    <li class="active">{{trans("levels.link_create")}}</li>
                </ol>
            </div>
            <div class="panel-body container-fluid">
                <div class="row row-lg">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="example-wrap">
                                        ...
                                        @if($parents)
                                            @foreach($parents as $item)
                                                <option value="{{$item->id}}"
                                                        @if($item->id==old("parent")) selected @endif>{{$item->name}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                            ...
                            <div class="form-group required {{$errors->has('target')?'has-error':''}}">
                                ...
                                <div class="col-md-10">
                                    {!! Form::number("target",old('target'),['class'=>'form-control','id'=>'target','min'=>0]) !!}
                            ...
                            <div class="form-group required {{$errors->has('min')?'has-error':''}}">
                                ...
                                <div class="col-md-10">
                                    {!! Form::number("min",old('min'),['class'=>'form-control','id'=>'min','min'=>0]) !!}
                                    @if ($errors->has('min'))
                                        <span class="help-block">
                    ...
                    <div class="col-md-4 col-sm-4  {{$errors->has('photo')?'has-error':''}}"
                        ...
                        <div ng-repeat="f in photos" style="font-family:'smaller'">
                            <div class="thumbnail">
                                ...
                                <div class="progress  active" ng-show="f.progress >= 0 && f.progress<100" ng-hide="f.progress>=100"
                                     ng-if="f">

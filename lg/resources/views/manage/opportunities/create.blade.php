                    ...
                    <div class="example-wrap">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group required form-group form-material-lg "
                                ...
                                <div class="col-sm-9">
                                    <select name="distributor" id="distributor" class="select2 form-control">
                                        <option value=""></option>
                                        @if($distributors)
                                    ...
                                    <span class="help-block"
                                          ng-show="errors.distributor"><% errors.distributor %></span>
                                </div>
                            ...
                            <div class="form-group required form-group form-material-lg "
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <span class="help-block" ng-show="errors.client"><% errors.client %></span>
                                </div>
                        ...
                        <div class="col-md-6" data-ng-controller="opportunitiesProductsCtrl">

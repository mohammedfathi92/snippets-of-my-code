...
@section('page_title', __('title.contract.fees'))

@section('page_header')
    <h1><i class="fa fa-list-ul"></i> <span> الرسوم الادارية </span> <a href="{{route('contracts.create',1)}}"
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <div class=box-body">
                        {!! Form::open(['route'=>'contracts.search_fees','method'=>'get']) !!}
                ...
                <div class="raw">
                    <div class="box box-success box-solid">
                        <div class="box-header">
                            <h3 class="box-title"><i class="fa fa-list-alt"></i> قائمة رسومات العقود </h3>
                        </div>
                            ...
                            <table id="aqTable" class="table table-striped table-bordered table-hover display   "
                                ...
                                @foreach($contracts->get() as $contract)
                                    <tr>
                                        ...
                                        <td>
                                           {{$contract->contract_fees_payment}}
                                        </td>
                                        <td>
                                            {{$contract->fees - $contract->contract_fees_payment}}
                                        </td>
                                        <td>
                                        @if($contract->fees != 0  && ($contract->fees - $contract->contract_fees_payment) != 0)
                                            <button class="btn btn-sm btn-primary fa fa-paypal" type="button"  data-toggle="modal"
                                                    data-target="#exampleModal" data-whatever="@mdo"
                                                    onclick="payfees({{$contract->id}});">
                                                <span> دفع </span>
                                            </button>
                                            @else
                                                <span> لا توجد رسوم اداريه لهذا العقد </span>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content" id="payment_fees">
...
@section('javascript')
    ...
    <script>
        ...
        function payfees(id) {
            $.ajax({
                type: 'post',
                url: '/admin/contracts/ajax_payment_fees',
                data: {id:id},
                success: function (data) {
                    $("#payment_fees").html(data);
                }
            });
        }

...
@section('page_title', __('title.contract.conflict'))

@section('page_header')
    <h1><i class="fa fa-list-ul"></i> <span> العقود المتعثره </span> <a href="{{route('contracts.create',1)}}"
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        {!! Form::open(['route'=>'contracts.search_conflict','method'=>'get']) !!}

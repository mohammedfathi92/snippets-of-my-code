...
@section('page_title', __('title.client.create'))

@section('content')

 @section('page_header')
<h1><i class="fa fa-user"></i>عميل جديد</h1>
@endsection
        ...
        <div class="row">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title"> <i class="fa fa-user"></i> بيانات العميل</h3>
            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-4">
                                    <div class="form-group {{ $errors->has('full_name') ? ' has-error' : '' }}">
                                        <label>العميل<span class="label label-info label-sm"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group {{ $errors->has('formal_name') ? ' has-error' : '' }}">
                                        ...
                                        <input tabindex="2" name="formal_name" id="offical_name" value="{{ old('formal_name') }}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group {{ $errors->has('mobile') ? ' has-error' : '' }}">
                                        ...
                                        <div class="intl-tel-input allow-dropdown separate-dial-code iti-sdc-3">
                                            <input tabindex="6" style="width:100%!important;" name="mobile" value="{{old('mobile')}}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group {{ $errors->has('phone') ? ' has-error' : '' }}">
                                        ...
                                        <div class="intl-tel-input allow-dropdown separate-dial-code iti-sdc-3">
                                            <input tabindex="7" style="width:100%!important;" name="phone" value="{{old('phone')}}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group {{ $errors->has('address') ? ' has-error' : '' }}">
                                        <label>العنوان</label>
                                        <input tabindex="8" name="address" value="{{old('address')}}" placeholder="يكتب عنوان العميل هنا"
                                               class="form-control ">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group {{ $errors->has('work_phone') ? ' has-error' : '' }}">
                                        ...
                                        <div class="intl-tel-input allow-dropdown separate-dial-code iti-sdc-3">
                                            ...
                                            <input tabindex="10" name="work_phone" value="{{old('work_phone')}}" class="form-control"placeholder="رقم ثابت" autocomplete="off">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group {{ $errors->has('nationality') ? ' has-error' : '' }}">
                                        <label>الجنسية</label>
                                        <input tabindex="11" name="nationality" value="{{old('nationality')}}" placeholder="جنسية العميل"
                                               class="form-control  ">
                                ...
                                {{--<div class="col-md-4">--}}
                                    {{--<div class="form-group {{ $errors->has('email') ? ' has-error' : '' }}">--}}
                                        ...
                                        {{--<input tabindex="12" name="email" value="{{old('email')}}" placeholder="example@website.com"--}}
            ...
            <div class="box-footer">
                <button type="submit" class="btn btn-primary my_btn_left"><i class="fa fa-plus-circle"></i> اضافة</button>
              </div>

...
@section('page_title', __('title.client.edit'))

@section('content')

@section('page_header')
    <h1><i class="fa fa-edit"></i>تعديل بيانات العميل</h1>
@endsection
<section class="content">
    <div class="row">
        ...
        {!! Form::open(['route'=>['clients.update',$client->id],'method'=>'post']) !!}

        <!-- general form elements -->
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title"><i class="fa fa-edit"></i> تعديل بيانات العميل</h3>
                </div>
                <div class="box-body">
                    <div class="form-group">
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('full_name') ? ' has-error' : '' }}">
                                ...
                                <input tabindex="1" name="full_name" value="{{ old('full_name',isset($client) ? $client->name: '') }}"
                        ...
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('formal_name') ? ' has-error' : '' }}">
                                ...
                                <input tabindex="1" name="formal_name" value="{{old('formal_name', isset($client)? $client->profile->formal_name : '') }}"
                        ...
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('national_id') ? ' has-error' : '' }}">
                                ...
                                <input tabindex="2" name="national_id" value="{{ old('national_id',isset($client)? $client->profile->national_id:'') }}"
                                ...
                                <div class="form-group {{ $errors->has('release_date') ? ' has-error' : '' }}">
                                    ...
                                    <div class="input-group">
                                            <input type="text" style="display:none;" disabled="disabled"
                                                   ...
                                                   class="form-control " value="{{ old('release_date',isset($client)? $client->profile->release_date:'' ) }}"/>
                        ...
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('release_place') ? ' has-error' : '' }}">
                                ...
                                <input tabindex="4" name="release_place" value="{{ old('release_place',isset($client)? $client->profile->release_place : '')}}"
                        ...
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('mobile') ? ' has-error' : '' }}">
                                ...
                                <input tabindex="5" style="width:100%!important;"
                                       name="mobile" value="{{ old('mobile',isset($client)? $client->profile->mobile:'')}}"
                        ...
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('phone') ? ' has-error' : '' }}">
                                ...
                                <input tabindex="5" style="width:100%!important;"
                                       name="phone" value="{{  old('phone',isset($client)? $client->profile->phone: '')}}"
                        ...
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('address') ? ' has-error' : '' }}">
                                ...
                                <input tabindex="8" name="address"
                                       value="{{ old('address',isset($client) ? $client->profile->address : '') }}"
                        ...
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('work') ? ' has-error' : '' }}">
                                <label>العمل</label>
                                <input tabindex="7" name="work" value="{{ old('work',isset($client)? $client->profile->work : '')}}"
                        ...
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('work_phone') ? ' has-error' : '' }}">
                                ...
                                <input tabindex="10" name="work_phone" value="{{old('work_phone',isset($client) ?  $client->profile->work_phone : '')}}"
                        ...
                        <div class="col-md-4">
                            <div class="form-group {{ $errors->has('nationality') ? ' has-error' : '' }}">
                                <label>الجنسية</label>
                                <input tabindex="6" name="nationality" value="{{ old('nationality',isset($client) ? $client->profile->nationality :'') }}"
                                    ...
                                    <div class="form-group {{ $errors->has('gender') ? ' has-error' : '' }}">
                                        <label>نوع الجنس</label>
                                          <select class="form-control " id="gender" name="gender">
                                                <option value="m" {{ $client->profile->gender == 'm' ? 'selected':'' }}>ذكر</option>
                                                 <option value="f" {{ $client->profile->gender == 'f' ? 'selected':'' }}>انثى</option>
                                                  <option value="c" {{ $client->profile->gender == 'c' ? 'selected':'' }}>شركة/ مؤسسة</option>
                        ...
                        {{--<input tabindex="12" name="email" value="{{$client->email}}"--}}

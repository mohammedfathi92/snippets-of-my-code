...
@section("page_header")
    <div class="content-header">
        <h1>
            Categories
            <small>Update <strong>{{$data->cat_title}} </strong>Category</small>
        </h1>
        <ol class="breadcrumb">
            ...
            <div class="box">
                ...
                <div class="box-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade in active" id="language_ar">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-xs-12">
                                        {!! Form::text("title[ar]",old('title[ar]',$data->translate('ar')->cat_title),['class'=>'form-control','required']) !!}
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-xs-12">
                                        {!! Form::textarea("description[ar]",old('description',$data->translate('ar')->cat_description),['class'=>'form-control']) !!}
                                    </div>
                            ...
                            <div class="tab-pane fade " id="language_en">
                                ...
                                <div class="form-group">
                                    {!! Form::label("title",trans('categories.label_title')." *",['class'=>'label-control col-md-3']) !!}
                                    <div class="col-md-9 col-xs-12">
                                        {!! Form::text("title[en]",old('title[en]',$data->translate('en')->cat_title),['class'=>'form-control']) !!}
                                    </div>
                                ...
                                <div class="form-group">
                                    {!! Form::label("description",trans('categories.label_description'),['class'=>'label-control col-md-3']) !!}
                                    <div class="col-md-9 col-xs-12">
                                        {!! Form::textarea("description[en]",old('description[en]',$data->translate('en')->cat_description),['class'=>'form-control']) !!}
                                    </div>
                    ...
                    {{--<div class="form-group">
                        ...
                        <div class="col-md-9 col-xs-12">
                            {!! Form::text("slug",old('slug',$data->cat_slug),['class'=>'form-control']) !!}
                        </div>
                    ...
                    <div class="form-group" ng-controller="filesController as fCtrl">
                        ...
                        <div class="col-md-9 col-xs-12">
                            @if($data->cat_photo)
                                ...
                                <div class="row">
                                    <a href="javascript:;" data-ng-click="delete('{{$data->cat_photo}}',$event)"
                                       class="">
                                        <i class="fa fa-trash-o"></i>
                                    </a>
                                    <input type="hidden" name="old_photo" value="{{$data->cat_photo}}">
                                    <a href="{{asset($data->cat_photo)}}" target="_blank">
                                        <img src="{{asset($data->cat_photo)}}" alt=""

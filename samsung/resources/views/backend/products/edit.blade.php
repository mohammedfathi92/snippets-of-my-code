...
@section("page_header")
    <div class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">{{trans("products.update_product")}}</li>
        </ol>
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade in active" id="language_ar">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 col-xs-12">
                                                    {!! Form::text("name[ar]",$data->translateOrNew('ar')->name,['class'=>'form-control']) !!}
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9 col-xs-12">
                                                    {!! Form::textarea("description[ar]",old('description[ar]',$data->translateOrNew('ar')->description),['class'=>'form-control ckeditor']) !!}
                                                </div>
                                        ...
                                        <div class="tab-pane fade " id="language_en">
                                            ...
                                            <div class="form-group">
                                                {!! Form::label("name",trans('products.label_name')." *",['class'=>'label-control col-md-3','required']) !!}
                                                <div class="col-md-9 col-xs-12">
                                                    {!! Form::text("name[en]",old('name[en]',$data->translateOrNew('en')->name),['class'=>'form-control']) !!}
                                                </div>
                                            ...
                                            <div class="form-group">
                                                {!! Form::label("description",trans('products.label_description'),['class'=>'label-control col-md-3']) !!}
                                                <div class="col-md-9 col-xs-12">
                                                    {!! Form::textarea("description[en]",old('description[en]',$data->translateOrNew('en')->description),['class'=>'form-control ckeditor']) !!}
                                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="sort" class="form-control" min="0" value="{{old("sort",$data->sort)}}" step="1">
                                        </div>
                                    </div>
                                </div>

                                <div class="form-group" ng-controller="filesController as fCtrl">
                                ...
                                <div class="form-group" data-ng-controller="productsCtrl">
                                    ...
                                    <div class="row">
                                        @if($gallery)
                                            ...
                                            <div class="thumbnail col-md-2 col-xs-6"
                                                 data-ng-repeat="photo in product.gallery">
                                                <a href="#" class="btn btn-danger fa fa-trash"
                                                   data-ng-click="removeGalleryPhoto(photo.id,$index)"></a>
                                                <img data-ng-src="{{asset('<%photo.path%>')}}" alt="<%photo.name%>">
                                            </div>
                                            <div class="clearfix"></div>
                                    @endif
                                    ...
                                    <div class="col-md-9 col-md-12">
                                        <label for="showInHome">
                                            <input type="checkbox" data-ng-model="showInHome" name="show_in_home"
                                                   data-ng-checked="{{ $data->show_in_home }}"
                                                   data-ng-init="showInHome={{ $data->show_in_home }}"
                                                   value="1" id="showInHome"/> {{trans('products.label_show')}}

                                        </label>
                                        <div class="col-md-12" data-ng-show="showInHome">
                                            ...
                                            <div>
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <textarea name="slide_description[ar]" id="slideDescriptionAr"
                                                              cols="70"
                                                              rows="5">{{$data->translateOrNew('ar')->slide_description}}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <textarea name="slide_description[en]" id="slideDescriptionAr"
                                                              cols="70"
                                                              rows="5">{{$data->translateOrNew('en')->slide_description}}</textarea>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="form-group">
                                                <label for="slidePhoto"
                                                       class="col-md-3">{{trans('products.label_slide_photo')}}</label>

                                                <div class="col-md-9">
                                                    @if($data->slide_photo)
                                                        <div class="col-md-5">
                                                            <img class="thumbnail" style="with:100px;height:200px"
                                                                 src="{{url($data->slide_photo)}}" alt="slide_photo">
                                                        </div>
                                                    @endif
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-9">
                                                    @if($data->slide_background)
                                                        <div class="col-md-5">
                                                            <img class="thumbnail" style="with:100px;height:200px"
                                                                 src="{{url($data->slide_background)}}"
                                                                 alt="slide_background">
                                                        </div>
                                                    @endif
                            ...
                            <div class="tab-pane" id="tab_properties" data-ng-controller="categoryPropertiesCtrl">
                                ...
                                <div class="form-group" data-ng-init="selectedProduct={{$data->id}}">
                                    ...
                                    <div class="col-md-9 col-xs-12">
                                        <select name="category" id="category" data-ng-model="selectedCategory"
                                                data-ng-init="selectedCategory='{{$data->category}}'"
                                                class="form-control select2">
                                            <option value=""></option>
                                            @if($categories)
                                                @foreach($categories as $cat)
                                                    <option value="{{$cat->id}}"
                                                            @if(old('category',$data->category)==$cat->id) selected @endif >{{$cat->cat_title}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                                    ...
                                                    <div class="col-md-7">
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="value[<% property.id%>][ar]"
                                                                   class="form-control"
                                                                   id="<%property.id%>ar" value="<%property.value.ar%>">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-7">
                                                        ...
                                                        <span class="input-group-addon"><i
                                                            ...
                                                            <input type="text" name="value[<% property.id%>][en]"
                                                                   class="form-control"
                                                                   id="<%property.id%>" value="<%property.value.en%>">
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="filters" class="col-md-9">
                                        <div class="panel-group" data-ng-controller="productsFiltersCtrl"
                                             data-ng-init="selectedProduct='{{$data->id}}'">
                                                            ...
                                                            <ul class="list-group"
                                                                ...
                                                                <li class="list-group-item"
                                                                    ...
                                                                    <label for="filter_<% sub.id %>">
                                                                        <input type="checkbox" id="filter_<% sub.id %>"
                                                                               data-ng-checked="sub.checked"
                                                                               name="filters[]" value="<%sub.id%>">
                                                                        <% sub.name %>
                                                                    </label>
